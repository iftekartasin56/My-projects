 ...
 */ !(function (t, e) {
    ...
    var e = {};
    function i(e, i, s, o) {
        e.hasOwnProperty(i) || ((e[i] = o.apply(null, s)), "function" == typeof CustomEvent && t.dispatchEvent(new CustomEvent("HighchartsModuleLoaded", { detail: { path: i, module: e[i] } })));
    }
    return (
 ...
 - ${i}: ${e}`),
            ...
            let T = {
                addEvent: function (e, i, s, o = {}) {
                    ...
                    a && a.call(e, i, s, !!t.supportsPassiveEvents && { passive: void 0 === o.passive ? -1 !== i.indexOf("touch") : o.passive, capture: !1 }), n[i] || (n[i] = []);
                ...
                createElement: function (t, e, i, o, r) {
                    ...
                    return e && m(n, e), r && y(n, { padding: "0", border: "none", margin: "0" }), i && y(n, i), o && o.appendChild(n), n;
                },
                css: y,
                defined: u,
                        ...
                        !e &&
                            ...
                            !1 === s &&
                                (1 === i
                                    ...
                                    : i <= 0.1 && (e = [1 / i]))),
                            r = 0;
                        r < e.length && ((n = e[r]), (!o || !(n * i >= t)) && (o || !(a <= (e[r] + (e[r + 1] || e[r])) / 2)));
                        r++
                    );
                ...
                offset: function (t) {
                    let e = s.documentElement,
                        i = t.parentElement || t.parentNode ? t.getBoundingClientRect() : { top: 0, left: 0, width: 0, height: 0 };
                    return { top: i.top + (o.pageYOffset || e.scrollTop) - (e.clientTop || 0), left: i.left + (o.pageXOffset || e.scrollLeft) - (e.clientLeft || 0), width: i.width, height: i.height };
                },
                pad: function (t, e, i) {
        ...
        i(e, "Core/Time.js", [e["Core/Globals.js"], e["Core/Utilities.js"]], function (t, e) {
            let { win: i } = t,
                { defined: s, error: o, extend: r, isNumber: n, isObject: a, merge: h, objectEach: l, pad: d, pick: c, splat: p, timeUnits: u } = e,
            ...
            return class {
                ...
                makeTime(t, e, i, s, o, r) {
                    ...
                    return (
                        this.useUTC
                            ? ((n = this.Date.UTC.apply(0, arguments)), (a = this.getTimezoneOffset(n)), (n += a), a !== (h = this.getTimezoneOffset(n)) ? (n += h - a) : a - 36e5 !== this.getTimezoneOffset(n - 36e5) || f || (n -= 36e5))
                            : (n = new this.Date(t, e, c(i, 1), c(s, 0), c(o, 0), c(r, 0)).getTime()),
                        n
                    );
                }
                timezoneOffsetFunction() {
                    ...
                    return this.useUTC
                        ? e.timezone
                            ? (t) => {
                                  try {
                                      let [i, s, o, r, a = 0] = Intl.DateTimeFormat("en", { timeZone: e.timezone, timeZoneName: "shortOffset" })
                                              .format(t)
                                              .split(/(GMT|:)/)
                                              .map(Number),
                                          h = -(36e5 * (o + a / 60));
                ...
                getTimeTicks(t, e, i, o) {
                    ...
                    if (((o = c(o, 1)), s(e))) {
                        d.set("Milliseconds", m, x >= u.second ? 0 : y * Math.floor(d.get("Milliseconds", m) / y)),
                            ...
                            x >= u.month && (d.set("Month", m, x >= u.year ? 0 : y * Math.floor(d.get("Month", m) / y)), (a = d.get("FullYear", m))),
                            x >= u.year && ((a -= a % y), d.set("FullYear", m, a)),
                            x === u.week && ((l = d.get("Day", m)), d.set("Date", m, d.get("Date", m) - l + o + (l < o ? -7 : 0))),
                            (a = d.get("FullYear", m));
                        let t = d.get("Month", m),
                            r = d.get("Date", m),
                            c = d.get("Hours", m);
            ...
            class a {
                ...
                run(t, e, i) {
                    ...
                    t !== e || this.elem["forceAnimate:" + this.prop]
                        ? ((this.startTime = +new Date()), (this.start = t), (this.end = e), (this.unit = i), (this.now = this.start), (this.pos = 0), (n.elem = this.elem), (n.prop = this.prop), n() && 1 === a.timers.push(n) && h(l))
                    ...
                    return (
                        r.attr && !r.element
                            ...
                            ? ((this.now = this.end),
                              ...
                              i && a && a.call(r),
                              (e = !1))
                            : ((this.pos = o.easing((s - this.startTime) / h)), (this.now = this.start + (this.end - this.start) * this.pos), this.update(), (e = !0)),
                        e
                    );
                }
                initPath(t, e, i) {
            ...
            return {
                animate: function (e, i, l) {
                    let d,
                        ...
                        g,
                        f;
                    n(l) || ((f = arguments), (l = { duration: f[2], easing: f[3], complete: f[4] })),
                        ...
                        h(i, function (r, n) {
                            c(e, n),
                                (g = new t(e, l, n)),
                                (u = void 0),
                                "d" === n && o(i.d) ? ((g.paths = g.initPath(e, e.pathArray, i.d)), (g.toD = i.d), (d = 0), (u = 1)) : e.attr ? (d = e.attr(n)) : ((d = parseFloat(s(e, n)) || 0), "opacity" !== n && (p = "px")),
                                u || (u = r),
        ...
        i(e, "Core/Renderer/HTML/AST.js", [e["Core/Globals.js"], e["Core/Utilities.js"]], function (t, e) {
            let { SVG_NS: i, win: s } = t,
                { attr: o, createElement: r, css: n, error: a, isFunction: h, isString: l, objectEach: d, splat: c } = e,
                { trustedTypes: p } = s,
                u = p && h(p.createPolicy) && p.createPolicy("highcharts", { createHTML: (t) => t }),
                g = u ? u.createHTML("") : "",
                f = (function () {
                    try {
                    ...
                    return (
                        d(t, (e, i) => {
                            ...
                            -1 === m.allowedAttributes.indexOf(i) && (s = !1),
                                ...
                                s || (a(33, !1, void 0, { "Invalid attribute in config": `${i}` }), delete t[i]),
        ...
        i(e, "Core/Templating.js", [e["Core/Defaults.js"], e["Core/Utilities.js"]], function (t, e) {
            let { defaultOptions: i, defaultTime: s } = t,
                { extend: o, getNestedProperty: r, isArray: n, isNumber: a, isObject: h, isString: l, pick: d, pInt: c } = e,
                p = {
                    add: (t, e) => t + e,
                    divide: (t, e) => (0 !== e ? t / e : ""),
                    eq: (t, e) => t == e,
                    each: function (t) {
                        ...
                        return !!n(t) && t.map((i, s) => u(e.body, o(h(i) ? i : { "@this": i }, { "@index": s, "@first": 0 === s, "@last": s === t.length - 1 }))).join("");
                    },
                    ge: (t, e) => t >= e,
                    gt: (t, e) => t > e,
                    if: (t) => !!t,
            ...
            function u(t = "", e, o) {
                ...
                for (; null !== (b = n.exec(t)); ) {
                    let i = a.exec(b[1]);
                    i && ((b = i), (k = !0)), (v && v.isBlock) || (v = { ctx: e, expression: b[1], find: b[0], isBlock: "#" === b[1].charAt(0), start: b.index, startInner: b.index + b[0].length, length: b[0].length });
            ...
            function g(t, e, s, o) {
                ...
                -1 === e
                    ? (e = Math.min(l, 20))
                    : a(e)
                    ? e && p[1] && p[1] < 0 && ((n = e + +p[1]) >= 0 ? ((p[0] = (+p[0]).toExponential(n).split("e")[0]), (e = n)) : ((p[0] = p[0].split(".")[0] || 0), (t = e < 20 ? (p[0] * Math.pow(10, p[1])).toFixed(e) : 0), (p[1] = 0)))
                    : (e = 2);
                ...
                return (
                    ...
                    0 > +p[1] && !u ? (r = "0") : (r += f.substr(m).replace(/(\d{3})(?=\d)/g, "$1" + o)),
                    e && (r += s + g.slice(-e)),
                    p[1] && 0 != +r && (r += "e" + p[1]),
                    r
                );
        ...
        i(e, "Core/Renderer/RendererUtilities.js", [e["Core/Utilities.js"]], function (t) {
            ...
            return (
                ((e || (e = {})).distribute = function t(e, n, a) {
                    ...
                    if (S > l) {
                        for (r(e, (t, e) => (e.rank || 0) - (t.rank || 0)), x = (k = e[0].rank === e[e.length - 1].rank) ? p / 2 : -1, m = k ? x : p - 1; x && S > l; )
                            (b = e[(f = Math.floor(m))]), o(u, f) && (S -= b.size), (m += x), k && m >= e.length && ((x /= 2), (m = x));
                        u.sort((t, e) => e - t).forEach((t) => g.apply(c, e.splice(t, 1)));
                    }
                    for (r(e, d), e = e.map((t) => ({ size: t.size, targets: [t.target], align: s(t.align, 0.5) })); y; ) {
                    ...
                    return (
                        ...
                        e.some((e) => {
                            ...
                            return (e.targets || []).some(() =>
                                ((h[f].pos = e.pos + i), void 0 !== a && Math.abs(h[f].pos - h[f].target) > a)
                                    ? (h.slice(0, f + 1).forEach((t) => delete t.pos), (h.reducedLen = (h.reducedLen || n) - 0.1 * n), h.reducedLen > 0.1 * n && t(h, n, a), !0)
                                    : ((i += h[f].size), f++, !1)
                            );
                        }),
                        r(h, d),
        ...
        i(e, "Core/Renderer/SVG/SVGElement.js", [e["Core/Animation/AnimationUtilities.js"], e["Core/Color/Color.js"], e["Core/Globals.js"], e["Core/Utilities.js"]], function (t, e, i, s) {
            ...
            class D {
                ...
                align(t, e, i) {
                    ...
                    let h = {},
                        ...
                        d = l.alignedObjects;
                    t
                        ? ((this.alignOptions = t), (this.alignByTranslate = e), (!i || C(i)) && ((this.alignTo = r = i || "renderer"), y(d, this), d.push(this), (i = void 0)))
                        : ((t = this.alignOptions), (e = this.alignByTranslate), (r = this.alignTo)),
                        (i = A(i, l[r], "scrollablePlotBox" === r ? l.plotBox : void 0, l));
                    let c = t.align,
                        p = t.verticalAlign;
                    return (
                        (s = (i.x || 0) + (t.x || 0)),
                ...
                applyTextOutline(t) {
                    ...
                    if (n && "none" !== n && i.svg) {
                        ...
                        g(t, { class: "highcharts-text-outline", fill: r, stroke: r, "stroke-width": n, "stroke-linejoin": "round" });
                        ...
                        (o.textContent = "​"), g(o, { x: Number(e.getAttribute("x")), dy: -s }), t.appendChild(o), i.insertBefore(t, i.firstChild);
                    }
                }
                attr(t, e, i, s) {
                    let o = this.element,
                        ...
                        "string" == typeof t
                            ...
                            : (T(
                                  ...
                                  function (e, i) {
                                      (d = !1),
                                          s || n(this, i),
                                          this.symbolName && -1 !== r.indexOf(i) && (h || (this.symbolAttr(t), (h = !0)), (d = !0)),
                                          this.rotation && ("x" === i || "y" === i) && (this.doTransform = !0),
                                          d || (this[i + "Setter"] || this._defaultSetter).call(this, e, i, o);
                                  },
                                  this
                              ),
                              this.afterSetters()),
                    ...
                    v(this.renderer, "complexColor", { args: arguments }, function () {
                        if ((t.radialGradient ? (n = "radialGradient") : t.linearGradient && (n = "linearGradient"), n)) {
                            if (
                                ...
                                (d = t.stops),
                                (u = s.radialReference),
                                S(a) && (t[n] = a = { x1: a[0], y1: a[1], x2: a[2], y2: a[3], gradientUnits: "userSpaceOnUse" }),
                                "radialGradient" === n && u && !x(a.gradientUnits) && ((h = a), (a = w(a, o.getRadialAttr(u, h), { gradientUnits: "userSpaceOnUse" }))),
                                T(a, function (t, e) {
                                    "id" !== e && f.push(e, t);
                                }),
                                T(d, function (t) {
                                ...
                                (t.radAttr = h),
                                    ...
                                    d.forEach(function (i) {
                                        ...
                                        let s = o.createElement("stop").attr({ offset: i[0], "stop-color": c, "stop-opacity": p }).add(t);
                                        t.stops.push(s);
                                    });
                            }
                            (m = "url(" + o.url + "#" + g + ")"),
                ...
                css(t) {
                    ...
                    if (
                        ...
                        e && (t = b(e, i)),
                            null === t.width || "auto" === t.width ? delete this.textWidth : "text" === s.nodeName.toLowerCase() && t.width && (o = this.textWidth = P(t.width)),
                            (this.styles = t),
                ...
                dSetter(t, e, i) {
                    S(t) && ("string" == typeof t[0] && (t = this.renderer.pathToSegments(t)), (this.pathArray = t), (t = t.reduce((t, e, i) => (e && e.join ? (i ? t + " " : "") + e.join(" ") : (e || "").toString()), ""))),
                ...
                getBBox(t, e) {
                    ...
                    if (
                        (x(p) && (-1 === (n = p.toString()).indexOf("<") && (n = n.replace(/[0-9]/g, "0")), (n += ["", d.rootFontSize, v, y, this.textWidth, h, c && c.textOverflow, c && c.fontWeight].join(","))), n && !t && (i = u[n]), !i)
                    ) {
                        if (f || d.forExport) {
                            try {
                                (r =
                                    ...
                                    k(r) && r("none"),
                                    (i = l.getBBox ? b({}, l.getBBox()) : { width: l.offsetWidth, height: l.offsetHeight, x: 0, y: 0 }),
                                    k(r) && r("");
                            } catch (t) {}
                            (!i || i.width < 0) && (i = { x: 0, y: 0, width: 0, height: 0 });
                        } else i = this.htmlGetBBox();
                        if (((s = i.width), (o = i.height), f && (i.height = o = { "11px,17": 14, "13px,20": 16 }[`${v || ""},${Math.round(o)}`] || o), y)) {
                    ...
                    if (((t = t || (o && o.path)), o && o.undo(), t && n)) {
                        let e = u(s, "afterModifyTree", (e) => {
                            if (t && n) {
                                ...
                                (e.nodes.length = 0), (e.nodes[0] = { tagName: "textPath", attributes: b(r, { "text-anchor": r.textAnchor, href: `${i}#${o}` }), children: a });
                            }
                        });
                ...
                strokeWidth() {
                    ...
                    return (
                        t.indexOf("px") === t.length - 2
                            ? (e = P(t))
                            : "" !== t && (g((i = h.createElementNS(c, "rect")), { width: t, "stroke-width": 0 }), this.element.parentNode.appendChild(i), (e = i.getBBox().width), i.parentNode.removeChild(i)),
                        e
                    );
                }
                symbolAttr(t) {
                ...
                updateTransform(t = "transform") {
                    let { element: e, matrix: i, rotation: s = 0, scaleX: o, scaleY: r, translateX: n = 0, translateY: a = 0 } = this,
                        h = ["translate(" + n + "," + a + ")"];
                    x(i) && h.push("matrix(" + i.join(",") + ")"),
                        s && h.push("rotate(" + s + " " + A(this.rotationOriginX, e.getAttribute("x"), 0) + " " + A(this.rotationOriginY, e.getAttribute("y") || 0) + ")"),
                        (x(o) || x(r)) && h.push("scale(" + A(o, 1) + " " + A(r, 1) + ")"),
                        h.length && !(this.text || this).textPath && e.setAttribute(t, h.join(" "));
                }
                ...
                zIndexSetter(t, e) {
                    ...
                    if ((x(t) ? (n.setAttribute("data-z-index", t), (t = +t), this[e] === t && (u = !1)) : x(this[e]) && n.removeAttribute("data-z-index"), (this[e] = t), u)) {
                        for ((t = this.zIndex) && s && (s.handleZ = !0), g = (h = r.childNodes).length - 1; g >= 0 && !c; g--)
                            (p = !x((d = (l = h[g]).getAttribute("data-z-index")))),
                                l !== n && (t < 0 && p && !a && !g ? (r.insertBefore(n, h[g]), (c = !0)) : (P(d) <= t || (p && (!x(t) || t >= 0))) && (r.insertBefore(n, h[g + 1]), (c = !0)));
            ...
            return (
                (D.symbolCustomAttribs = ["anchorX", "anchorY", "clockwise", "end", "height", "innerR", "r", "start", "width", "x", "y"]),
            ...
            class h extends t {
                constructor(t, e, i, s, o, r, n, a, l, d) {
                    ...
                    super(t, "g"),
                        ...
                        "string" == typeof o && ((c = /^url\((.*?)\)$/.test(o)) || this.renderer.symbols[o]) && (this.symbolKey = o),
                ...
                onAdd() {
                    this.text.add(this), this.attr({ text: n(this.textStr, ""), x: this.x || 0, y: this.y || 0 }), this.box && i(this.anchorX) && this.attr({ anchorX: this.anchorX, anchorY: this.anchorY });
                }
                paddingSetter(t, e) {
                ...
                updateTextPadding() {
                    ...
                    if (!t.textPath) {
                        ...
                        i(this.widthSetting) && this.bBox && ("center" === this.textAlign || "right" === this.textAlign) && (s += { center: 0.5, right: 1 }[this.textAlign] * (this.widthSetting - this.bBox.width)),
                            (s !== t.x || e !== t.y) && (t.attr("x", s), t.hasBoxWidthChanged && (this.bBox = t.getBBox(!0)), void 0 !== e && t.attr("y", e)),
                            (t.x = s),
                            (t.y = e);
                    }
                }
            ...
            function o(t, i, o, r, n) {
                ...
                if (n) {
                    ...
                    (v.params = { start: h, end: p, cx: t, cy: i }),
                        ...
                        e(u) && (((v = ["A", u, u, 0, b, e(n.clockwise) ? 1 - n.clockwise : 0, t + u * f, i + u * m]).params = { start: p, end: h, cx: t, cy: i }), a.push(g ? ["M", t + u * x, i + u * y] : ["L", t + u * x, i + u * y], v)),
                        g || a.push(["Z"]);
                }
                return a;
            }
            ...
            return {
                ...
                callout: function (t, e, s, o, r) {
                    ...
                    if (t + l > s - h) {
                        ...
                        d > o && l < s - h
                            ? c.splice(5, 1, ["L", l + 6, e + o], ["L", l, e + o + 6], ["L", l - 6, e + o], ["L", t + a, e + o])
                            : d < 0 && l > h && c.splice(1, 1, ["L", l - 6, e], ["L", l, e - 6], ["L", l + 6, e], ["L", s - a, e]);
                    return c;
                },
                circle: function (t, e, i, s) {
                    return o(t + i / 2, e + s / 2, i / 2, s / 2, { start: 0.5 * Math.PI, end: 2.5 * Math.PI, open: !1 });
                },
            ...
            return class {
                ...
                modifyDOM() {
                    ...
                    [].forEach.call(e.element.querySelectorAll("tspan.highcharts-br"), (t, s) => {
                        t.nextSibling && t.previousSibling && (0 === s && 1 === t.previousSibling.nodeType && (e.firstLineMetrics = e.renderer.fontMetrics(t.previousSibling)), n(t, { dy: this.getLineHeight(t.nextSibling), x: i }));
                    });
                    let a = this.width || 0;
                    if (!a) return;
                    let h = (t, r) => {
                            let h = t.textContent || "",
                                ...
                                p = 0,
                                u = e.actualWidth;
                            if (this.ellipsis) h && this.truncate(t, h, void 0, 0, Math.max(0, a - 0.8 * c), (t, e) => t.substring(0, e) + "…");
                            else if (d) {
                                let h = [],
                                    d = [];
                                for (; r.firstChild && r.firstChild !== t; ) d.push(r.firstChild), r.removeChild(r.firstChild);
                                for (; l.length; )
                                    l.length && !this.noWrap && p > 0 && (h.push(t.textContent || ""), (t.textContent = l.join(" ").replace(/- /g, "-"))),
                ...
                modifyTree(t) {
                    let e = (i, s) => {
                        let { attributes: o = {}, children: r, style: n = {}, tagName: h } = i,
                            l = this.renderer.styledMode;
                        if (
                            ("b" === h || "strong" === h ? (l ? (o.class = "highcharts-strong") : (n.fontWeight = "bold")) : ("i" === h || "em" === h) && (l ? (o.class = "highcharts-emphasized") : (n.fontStyle = "italic")),
                        ...
                        } else "a" === h && r && r.some((t) => "#text" === t.tagName) && (i.children = [{ children: r, tagName: "tspan" }]);
                        "#text" !== h && "a" !== h && (i.tagName = "tspan"), a(i, { attributes: o, style: n }), r && r.filter((t) => "#text" !== t.tagName).forEach(e);
                    };
        ...
        i(
            ...
            function (t, e, i, s, o, r, n, a, h) {
                ...
                let { charts: d, deg2rad: c, doc: p, isFirefox: u, isMS: g, isWebKit: f, noop: m, SVG_NS: x, symbolSizes: y, win: b } = i,
                    { addEvent: v, attr: S, createElement: k, css: M, defined: C, destroyObjectProperties: w, extend: T, isArray: A, isNumber: P, isObject: L, isString: O, merge: D, pick: E, pInt: j, uniqueKey: I } = h;
                class B {
                    constructor(t, e, i, s, o, r, n) {
                        ...
                        c.element.appendChild(p.createTextNode("Created with Highcharts 11.3.0")),
                            ...
                            u &&
                                ...
                                ((a = function () {
                                    M(t, { left: 0, top: 0 }), (h = t.getBoundingClientRect()), M(t, { left: Math.ceil(h.left) - h.left + "px", top: Math.ceil(h.top) - h.top + "px" });
                                })(),
                                    ...
                                    i = new t([
                                        {
                                            ...
                                            children: [
                                                { tagName: "defs", children: [{ tagName: "clipPath", attributes: { id: e }, children: [{ tagName: "rect", attributes: { width: 4, height: 4 } }] }] },
                    ...
                    shadowDefinition(t) {
                        let e = [`highcharts-drop-shadow-${this.chartIndex}`, ...Object.keys(t).map((e) => `${e}-${t[e]}`)]
                                ...
                                .toLowerCase()
                                .replace(/[^a-z0-9\-]/g, ""),
                            i = D({ color: "#000000", offsetX: 1, offsetY: 1, opacity: 0.15, width: 5 }, t);
                        return (
                            this.defs.element.querySelector(`#${e}`) ||
                                this.definition({
                                    tagName: "filter",
                                    attributes: { id: e, filterUnits: i.filterUnits },
                                    children: [{ tagName: "feDropShadow", attributes: { dx: i.offsetX, dy: i.offsetY, "flood-color": i.color, "flood-opacity": Math.min(5 * i.opacity, 1), stdDeviation: i.width / 2 } }],
                                }),
                            e
                        );
                    }
                    ...
                    button(e, i, s, o, r = {}, n, a, h, l, d) {
                        ...
                        return (
                            ...
                            m ||
                                ((S = D({ fill: "#f7f7f7", stroke: "#cccccc", "stroke-width": 1 }, S)),
                                (c = (n = D(S, { fill: "#e6e6e6" }, t.filterUserAttributes(n || x.hover || {}))).style),
                                delete n.style,
                                (p = (a = D(S, { fill: "#e6e9ff", style: { color: "#000000", fontWeight: "bold" } }, t.filterUserAttributes(a || x.select || {}))).style),
                                delete a.style,
                                (u = (h = D(S, { style: { color: "#cccccc" } }, t.filterUserAttributes(h || x.disabled || {}))).style),
                                delete h.style),
                            ...
                            !m && (f.attr(S).css(T({ cursor: "default" }, b)), d && f.text.css({ pointerEvents: "none" })),
                            f
                    ...
                    arc(t, e, i, s, o, r) {
                        let n;
                        L(t) ? ((e = (n = t).y), (i = n.r), (s = n.innerR), (o = n.start), (r = n.end), (t = n.x)) : (n = { innerR: s, start: o, end: r });
                        let a = this.symbol("arc", t, e, i, i, n);
                        return (a.r = i), a;
                    }
                    rect(t, e, i, s, o, r) {
                        let n = L(t) ? t : void 0 === t ? {} : { x: t, y: e, r: o, width: Math.max(i || 0, 0), height: Math.max(s || 0, 0) },
                            a = this.createElement("rect");
                        return (
                            this.styledMode || (void 0 !== r && ((n["stroke-width"] = r), T(n, a.crisp(n))), (n.fill = "none")),
                    ...
                    symbol(t, e, i, s, o, r) {
                        ...
                        let c = this,
                            ...
                            m = f && this.symbols[f];
                        if (m)
                            "number" == typeof e && (a = m.call(this.symbols, Math.round(e || 0), Math.round(i || 0), s || 0, o || 0, r)),
                                (n = this.path(a)),
                                c.styledMode || n.attr("fill", "none"),
                                T(n, { symbolName: f || void 0, x: e, y: i, width: s, height: o }),
                                r && T(n, r);
                        else if (g) {
                            h = t.match(u)[1];
                            ...
                            (s.imgwidth = E(r && r.width, y[h] && y[h].width)),
                                ...
                                ["width", "height"].forEach((t) => {
                                    s[`${t}Setter`] = function (t, e) {
                                        this[e] = t;
                                        let { alignByTranslate: i, element: s, width: o, height: n, imgwidth: a, imgheight: h } = this,
                                            l = "width" === e ? a : h,
                                            d = 1;
                                        r && "within" === r.backgroundSize && o && n && a && h ? ((d = Math.min(o / a, n / h)), S(s, { width: Math.round(a * d), height: Math.round(h * d) })) : s && l && s.setAttribute(e, l),
                                            !i && a && h && this.translate(((o || 0) - a * d) / 2, ((n || 0) - h * d) / 2);
                                    };
                                }),
                                C(e) && s.attr({ x: e, y: i }),
                                (s.isImg = !0),
                                    ...
                                    : (s.attr({ width: 0, height: 0 }),
                                      k("img", {
                                          onload: function () {
                                              ...
                                              0 === this.width && (M(this, { position: "absolute", top: "-999em" }), p.body.appendChild(this)),
                    ...
                    pathToSegments(t) {
                        ...
                        for (let o = 0; o < t.length; o++)
                            O(i[0]) && P(t[o]) && i.length === s[i[0].toUpperCase()] && t.splice(o, 0, i[0].replace("M", "L").replace("m", "l")), "string" == typeof t[o] && (i.length && e.push(i.slice(0)), (i.length = 0)), i.push(t[o]);
                ...
                return T(B.prototype, { Element: o, SVG_NS: x, escapes: { "&": "&amp;", "<": "&lt;", ">": "&gt;", "'": "&#39;", '"': "&quot;" }, symbols: n, draw: m }), s.registerRendererType("svg", B, !0), B;
            }
        ),
            ...
            class l extends e {
                ...
                htmlCss(t) {
                    ...
                    let { element: i } = this,
                        ...
                        r = s && t.width;
                    return (
                        s && (delete t.width, (this.textWidth = h(r) || void 0), (e = !0)),
                        t?.textOverflow === "ellipsis" && ((t.whiteSpace = "nowrap"), (t.overflow = "hidden")),
                        n(this.styles, t),
                        o(i, t),
                ...
                htmlUpdateTransform() {
                    ...
                    let { element: t, renderer: e, rotation: i, styles: s, textAlign: n = "left", textWidth: a, translateX: h = 0, translateY: l = 0, x: d = 0, y: c = 0 } = this,
                    ...
                    if ((o(t, { marginLeft: `${h}px`, marginTop: `${l}px` }), "SPAN" === t.tagName)) {
                        ...
                        if (a !== this.oldTextWidth) {
                            let e = this.textPxLength ? this.textPxLength : (o(t, { width: "", whiteSpace: u || "nowrap" }), t.offsetWidth),
                                s = a || 0;
                            (s > this.oldTextWidth || e > s) &&
                                (/[ \-]/.test(t.textContent || t.innerText) || "ellipsis" === t.style.textOverflow) &&
                                (o(t, { width: e > s || i ? a + "px" : "auto", display: "block", whiteSpace: u || "normal" }), (this.oldTextWidth = a), (l = !0));
                        }
                        (this.hasBoxWidthChanged = l),
                            s !== this.cTT &&
                                ((h = e.fontMetrics(t).b), r(i) && (i !== (this.oldRotation || 0) || n !== this.oldAlign) && this.setSpanRotation(i, p, h), this.getSpanCorrection((!r(i) && this.textPxLength) || t.offsetWidth, h, p)),
                            o(t, { left: d + (this.xCorr || 0) + "px", top: c + (this.yCorr || 0) + "px" }),
                            (this.cTT = s),
                            (this.oldRotation = i),
                            (this.oldAlign = n);
                    }
            ...
            class c extends s {
                ...
                html(e, s, o) {
                    ...
                    return (
                        ...
                        r.attr({ text: e, x: Math.round(s), y: Math.round(o) }).css({ position: "absolute" }),
                        c.styledMode || r.css({ fontFamily: this.style.fontFamily, fontSize: this.style.fontSize }),
                                    ...
                                    o.reverse().forEach(function (t) {
                                        ...
                                        e = t.div =
                                            ...
                                            a(
                                                ...
                                                { position: "absolute", left: (t.translateX || 0) + "px", top: (t.translateY || 0) + "px", display: t.display, opacity: t.opacity, visibility: t.visibility },
                                                e || s
                                            );
                                        let g = e.style;
                                        h(t, {
                                            ...
                                            on: function () {
                                                return o[0].div && r.on.apply({ element: o[0].div, onEvents: t.onEvents }, arguments), t;
                                            },
                                            translateXSetter: c,
                                            translateYSetter: c,
                                        }),
        ...
        i(e, "Core/Axis/Tick.js", [e["Core/Templating.js"], e["Core/Globals.js"], e["Core/Utilities.js"]], function (t, e, i) {
            let { deg2rad: s } = e,
                { clamp: o, correctFloat: r, defined: n, destroyObjectProperties: a, extend: h, fireEvent: l, isNumber: d, merge: c, objectEach: p, pick: u } = i;
            return class {
                ...
                addLabel() {
                    ...
                    c && d(w) && (w = r(c.lin2log(w))),
                        i.dateTime && (v ? (k = (M = o.time.resolveDTLFormat(s.dateTimeLabelFormats[(!s.grid && v.higherRanks[g]) || v.unitName])).main) : d(w) && (k = i.dateTime.getXDateFormat(w, s.dateTimeLabelFormats || {}))),
                        (e.isFirst = x),
                        (e.isLast = y);
                    let T = { axis: i, chart: o, dateTimeLabelFormat: k, isFirst: x, isLast: y, pos: g, tick: e, tickPositionInfo: v, value: w };
                    ...
                    L
                        ...
                        n(S) || e.movedLabel
                            ? S && S.textStr !== P && !b && (!S.textWidth || f.style.width || S.styles.width || S.css({ width: null }), S.attr({ text: P }), (S.textPxLength = S.getBBox().width))
                ...
                getLabelPosition(t, e, i, o, r, a, h, d) {
                    ...
                    let g = this.axis,
                        ...
                        b = o || g.reserveSpaceDefault ? 0 : -g.labelOffset * ("center" === g.labelAlign ? 0.5 : 1),
                        v = r.distance,
                        S = {};
                    return (
                        (c = 0 === g.side ? (i.rotation ? -v : -i.getBBox().height) : 2 === g.side ? y.y + v : Math.cos(i.rotation * s) * (y.y - i.getBBox(!1, 0).height / 2)),
                        n(r.y) && (c = 0 === g.side && g.horiz ? r.y + c : r.y),
                        (t = t + u(r.x, [0, 1, 0, -1][g.side] * v) + b + y.x - (a && o ? a * f * (m ? -1 : 1) : 0)),
                        (e = e + c - (a && !o ? a * f * (m ? 1 : -1) : 0)),
                        x && ((p = (h / (d || 1)) % x), g.opposite && (p = x - p - 1), (e += p * (g.labelOffset / x))),
                        (S.x = t),
                        (S.y = Math.round(e)),
                        l(this, "afterGetLabelPosition", { pos: S, tickmarkOffset: a, index: h }),
                        S
                    );
                }
                getLabelSize() {
                ...
                handleOverflow(t) {
                    let e = this.axis,
                        ...
                        l = this.label,
                        d = this.rotation,
                        c = { left: 0, center: 0.5, right: 1 }[e.labelAlign || l.attr("align")],
                        p = l.getBBox().width,
                    ...
                    d || "justify" !== i.overflow
                        ? d < 0 && o - c * p < a
                            ...
                            : d > 0 && o + c * p > h && (y = Math.round((r - o) / Math.cos(d * s)))
                        : (o - c * p < a ? (m = t.x + m * (1 - c) - a) : o + (1 - c) * p > h && ((m = h - t.x + m * c), (x = -1)),
                          (m = Math.min(g, m)) < g && "center" === e.labelAlign && (t.x += x * (g - m - c * (g - Math.min(p, m)))),
                          (p > m || (e.autoRotation && (l.styles || {}).width)) && (y = m)),
                        y && (this.shortenLabel ? this.shortenLabel() : ((f.width = Math.floor(y) + "px"), (i.style || {}).textOverflow || (f.textOverflow = "ellipsis"), l.css(f)));
                }
                moveLabel(t, e) {
                    let i = this,
                        s = i.label,
                ...
                renderGridLine(t, e, i) {
                    ...
                    "minor" === this.type && ((p = o.minorGridLineWidth), (g = o.minorGridLineColor), (f = o.minorGridLineDashStyle)),
                        d ||
                            (s.chart.styledMode || ((r.stroke = g), (r["stroke-width"] = p || 0), (r.dashstyle = f)),
                            a || (r.zIndex = 1),
                            t && (e = 0),
                            (this.gridLine = d = l
                                .path()
                                ...
                                .add(s.gridGroup))),
                        d && (c = s.getPlotLinePath({ value: n + h, lineWidth: d.strokeWidth() * i, force: "pass", old: t, acrossPanes: !1 })) && d[t || this.isNew ? "attr" : "animate"]({ d: c, opacity: e });
                }
                renderMark(t, e, i) {
                    let s = this.axis,
                        o = s.options,
                    ...
                    a &&
                        ...
                        p[g ? "attr" : "animate"]({ d: this.getMarkPath(h, l, a[0], p.strokeWidth() * i, s.horiz, r), opacity: e }));
                }
                renderLabel(t, e, i, s) {
                    let o = this.axis,
                        r = o.horiz,
                    ...
                    a &&
                        ...
                        (!this.isFirst || this.isLast || n.showFirstLabel) && (!this.isLast || this.isFirst || n.showLastLabel) ? !r || h.step || h.rotation || e || 0 === i || this.handleOverflow(t) : (f = !1),
                        l && s % l && (f = !1),
                        f && d(t.y) ? ((t.opacity = i), a[this.isNewLabel ? "attr" : "animate"](t).show(!0), (this.isNewLabel = !1)) : (a.hide(), (this.isNewLabel = !0)));
                }
                replaceMovedLabel() {
                    let t = this.label,
                        e = this.axis;
        ...
        i(
            e,
            "Core/Axis/Axis.js",
            [e["Core/Animation/AnimationUtilities.js"], e["Core/Axis/AxisDefaults.js"], e["Core/Color/Color.js"], e["Core/Defaults.js"], e["Core/Foundation.js"], e["Core/Globals.js"], e["Core/Axis/Tick.js"], e["Core/Utilities.js"]],
            function (t, e, i, s, o, r, n, a) {
                let { animObject: h } = t,
                    ...
                    z = (t, e) => O(e, void 0, void 0, E(t.options.allowDecimals, e < 0.5 || void 0 !== t.tickAmount), !!t.tickAmount);
                ...
                class N {
                    ...
                    init(t, e, i = this.coll) {
                        ...
                        (this.chart = t),
                            ...
                            (this.side = E(e.side, this.side, o ? (this.opposite ? 0 : 2) : this.opposite ? 1 : 3)),
                            this.setOptions(e);
                        let r = this.options,
                            n = r.labels,
                            a = r.type;
                        (this.userOptions = e),
                            ...
                            (this.categories = (T(r.categories) && r.categories) || (this.hasNames ? [] : void 0)),
                        ...
                        (this.crosshair = !0 === h ? {} : h),
                            -1 === t.axes.indexOf(this) && (s ? t.axes.splice(t.xAxis.length, 0, this) : t.axes.push(this), w(this, t[this.coll])),
                                ...
                                e.series.forEach((i) => {
                                    if (i.reserveSpace()) {
                                        let s = i.options,
                                            ...
                                            n,
                                            a;
                                        if (((e.hasVisibleSeries = !0), e.positiveValuesOnly && 0 >= (r || 0) && (r = void 0), e.isXAxis))
                                            (o = i.xData) &&
                                                o.length &&
                                                ((o = e.logarithmic ? o.filter((t) => t > 0) : o),
                                                (n = (t = i.getXExtremes(o)).min),
                                                (a = t.max),
                                                A(n) || n instanceof Date || ((o = o.filter(A)), (n = (t = i.getXExtremes(o)).min), (a = t.max)),
                                                o.length && ((e.dataMin = Math.min(E(e.dataMin, n), n)), (e.dataMax = Math.max(E(e.dataMax, a), a))));
                                        else {
                                            let t = i.applyExtremes();
                                            A(t.dataMin) && ((n = t.dataMin), (e.dataMin = Math.min(E(e.dataMin, n), n))),
                                                A(t.dataMax) && ((a = t.dataMax), (e.dataMax = Math.max(E(e.dataMax, a), a))),
                                                y(r) && (e.threshold = r),
                    ...
                    getPlotLinePath(t) {
                        ...
                        return (
                            M(this, "getPlotLinePath", v, function (t) {
                                (u = f = Math.round((c = m((c = E(c, e.translate(n, void 0, void 0, r))), -1e5, 1e5)) + d)),
                                    (g = x = Math.round(h - c - d)),
                                    A(c) ? (e.horiz ? ((g = o), (x = h - e.bottom), (u = f = b(u, s, s + e.width))) : ((u = s), (f = l - e.right), (g = x = b(g, o, o + e.height)))) : ((y = !0), (p = !1)),
                                    (t.path =
                                        y && !p
                                            ? void 0
                    ...
                    adjustForMinRange() {
                        ...
                        this.isXAxis &&
                            void 0 === o &&
                            !e &&
                            (o = y(t.min) || y(t.max) || y(t.floor) || y(t.ceiling) ? null : Math.min(5 * (C(this.series.map((t) => (t.xIncrement ? t.xData?.slice(0, 2) : t.xData) || [])) || 0), this.dataMax - this.dataMin)),
                            A(i) &&
                                A(s) &&
                                A(o) &&
                                i - s < o &&
                                ...
                                (i = f(h)) - s < o && ((a[0] = i - o), (a[1] = E(t.min, i - o)), (s = g(a)))),
                            (this.minRange = o),
                            (this.min = s),
                            (this.max = i);
                    }
                    ...
                    updateNames() {
                        ...
                        i > 0 &&
                            ...
                            (this.series || []).forEach((e) => {
                                (e.xIncrement = null),
                                    (!e.points || e.isDirtyData) && ((t.max = Math.max(t.max, e.xData.length - 1)), e.processData(), e.generatePoints()),
                    ...
                    setTickInterval(t) {
                        let { categories: e, chart: i, dataMax: s, dataMin: o, dateTime: r, isXAxis: n, logarithmic: a, options: h, softThreshold: l } = this,
                        ...
                        if (
                            ...
                            b
                                ? ((this.linkedParent = b), (T = b.getExtremes()), (this.min = E(T.min, T.dataMin)), (this.max = E(T.max, T.dataMax)), h.type !== b.options.type && S(11, !0, i))
                                : (l && y(d) && A(s) && A(o) && (o >= d ? ((L = d), (C = 0)) : s <= d && ((O = d), (k = 0))), (this.min = E(D, L, o)), (this.max = E(j, O, s))),
                            A(this.max) &&
                                A(this.min) &&
                                (a && (this.positiveValuesOnly && !t && 0 >= Math.min(this.min, E(o, this.min)) && S(10, !0, i), (this.min = x(a.log2lin(this.min), 16)), (this.max = x(a.log2lin(this.max), 16))),
                                this.range && A(o) && ((this.userMin = this.min = D = Math.max(o, this.minFromRange() || 0)), (this.userMax = j = this.max), (this.range = void 0))),
                            ...
                            if (
                                ...
                                e || this.axisPointRange || this.stacking?.usePercentage || b || !(w = this.max - this.min) || (!y(D) && C && (this.min -= w * C), y(j) || !k || (this.max += w * k)),
                        ...
                        if (
                            (this.min !== this.max && A(this.min) && A(this.max)
                                ? b && !P && v === b.options.tickPixelInterval
                                    ...
                                    : (this.tickInterval = E(P, this.tickAmount ? w / Math.max(this.tickAmount - 1, 1) : void 0, e ? 1 : (w * v) / Math.max(this.len, v)))
                                : (this.tickInterval = 1),
                            n && !t)
                        ) {
                    ...
                    setTickPositions() {
                        let t = this.options,
                            ...
                            l;
                        if (
                            ((this.tickmarkOffset = this.categories && "between" === t.tickmarkPlacement && 1 === this.tickInterval ? 0.5 : 0),
                            ...
                            if (!this.ordinal?.positions && (this.max - this.min) / this.tickInterval > Math.max(2 * this.len, 200)) (h = [this.min, this.max]), S(19, !1, this.chart);
                            else if (this.dateTime) h = this.getTimeTicks(this.dateTime.normalizeTimeTickInterval(this.tickInterval, t.units), this.min, this.max, t.startOfWeek, this.ordinal?.positions, this.closestPointRange, !0);
                                ...
                                let t = this.tickInterval,
                                    e = t;
                                for (; e <= 2 * t; )
                                    if (((h = this.getLinearTickPositions(this.tickInterval, this.min, this.max)), this.tickAmount && h.length > this.tickAmount)) this.tickInterval = z(this, (e *= 1.1));
                                    else break;
                            }
                        ...
                        (this.tickPositions = h),
                            ...
                            !this.isLinked &&
                                A(this.min) &&
                                A(this.max) &&
                                (this.single && h.length < 2 && !this.categories && !this.series.some((t) => t.is("heatmap") && "between" === t.options.pointPlacement) && ((this.min -= 0.5), (this.max += 0.5)),
                    ...
                    adjustTickAmount() {
                        let t = this,
                            { finalTickAmt: e, max: i, min: s, options: o, tickPositions: r, tickAmount: n, thresholdAlignment: a } = t,
                            h = r?.length,
                            ...
                            f = () => r.unshift(x(r[0] - p));
                        if ((A(a) && ((u = a < 0.5 ? Math.ceil(a * (n - 1)) : Math.floor(a * (n - 1))), o.reversed && (u = n - 1 - u)), t.hasData() && A(s) && A(i))) {
                            let a = () => {
                    ...
                    setScale() {
                        ...
                        o || i || s || this.isLinked || this.forceRedraw || this.userMin !== (this.old && this.old.userMin) || this.userMax !== (this.old && this.old.userMax) || this.alignToOthers()
                            ? (e && "yAxis" === t && e.buildStacks(),
                              ...
                              this.isDirty || (this.isDirty = o || this.min !== this.old?.min || this.max !== this.old?.max))
                            : e && e.cleanStacks(),
                        ...
                        return (
                            M(this, "zoom", h, function (t) {
                                let e = t.newMin,
                                    r = t.newMax;
                                (e !== i.min || r !== i.max) &&
                                    (!i.allowZoomOutside && (y(s) && (e < n && (e = n), e > a && (e = a)), y(o) && (r < n && (r = n), r > a && (r = a))),
                    ...
                    getExtremes() {
                        ...
                        return { min: t ? x(t.lin2log(this.min)) : this.min, max: t ? x(t.lin2log(this.max)) : this.max, dataMin: this.dataMin, dataMax: this.dataMax, userMin: this.userMin, userMax: this.userMax };
                    }
                    getThreshold(t) {
                    ...
                    renderUnsquish() {
                        ...
                        if (
                            ...
                            for (u = "clip", m = i.length; !n && m--; )
                                (f = s[i[m]].label) &&
                                    (f.styles && "ellipsis" === f.styles.textOverflow ? f.css({ textOverflow: "clip" }) : f.textPxLength > a && f.css({ width: a + "px" }),
                                    f.getBBox().height > this.len / i.length - (d.h - d.f) && (f.specificTextOverflow = "ellipsis"));
                        l.rotation && ((p = g > 0.5 * t.chartHeight ? 0.33 * t.chartHeight : g), c || (u = "ellipsis")),
                            ...
                            i.forEach(function (t) {
                                ...
                                i &&
                                    ...
                                    e.shortenLabel
                                        ? e.shortenLabel()
                                        : p && !o && "nowrap" !== r.whiteSpace && (p < i.textPxLength || "SPAN" === i.element.tagName)
                                        ? ((n.width = p + "px"), c || (n.textOverflow = i.specificTextOverflow || u), i.css(n))
                                        : i.styles && i.styles.width && !n.width && !o && i.css({ width: null }),
                    ...
                    addTitle(t) {
                        ...
                        this.axisTitle ||
                            ((e = n.textAlign) || (e = (s ? { low: "left", middle: "center", high: "right" } : { low: o ? "right" : "left", middle: "center", high: o ? "left" : "right" })[n.align]),
                            (this.axisTitle = i
                            ...
                            a || n.style.width || this.isRadial || this.axisTitle.css({ width: this.len + "px" }),
                        ...
                        let { axisParent: t, chart: e, coll: i, options: s } = this,
                            ...
                            r = (e, r, n) =>
                                o
                                    .g(e)
                                    .attr({ zIndex: n })
                                    .addClass(`highcharts-${i.toLowerCase()}${r} ` + (this.isRadial ? `highcharts-radial-axis${r} ` : "") + (s.className || ""))
                                    .add(t);
                        ...
                        if (
                            ...
                            l || t.isLinked
                                ? (n.forEach(function (e) {
                                  ...
                                  t.renderUnsquish(),
                                  (t.reserveSpaceDefault = 0 === o || 2 === o || { 1: "left", 3: "right" }[o] === t.labelAlign),
                                  E(c.reserveSpace, !p && null, "center" === t.labelAlign || null, t.reserveSpaceDefault) &&
                            ...
                            d?.text && !1 !== d.enabled && (t.addTitle(m), m && !p && !1 !== d.reserveSpace && ((t.titleOffset = x = t.axisTitle.getBBox()[i ? "height" : "width"]), (v = y((b = d.offset)) ? 0 : E(d.margin, i ? 5 : 10)))),
                            t.renderLine(),
                            (t.offset = f * E(s.offset, u[o] ? u[o] + (s.margin || 0) : 0)),
                            (t.tickRotCorr = t.tickRotCorr || { x: 0, y: 0 }),
                            (C = 0 === o ? -t.labelMetrics().h : 2 === o ? t.tickRotCorr.y : 0),
                            (k = Math.abs(S) + v),
                            S && ((k -= C), (k += f * (i ? E(c.y, t.tickRotCorr.y + f * c.distance) : E(c.x, f * c.distance)))),
                    ...
                    getTitlePosition(t) {
                        let e = this.horiz,
                            ...
                            f = { x: e ? u + l : g + (a ? this.width : 0) + h + l, y: e ? g + d - (a ? this.height : 0) + h : u + d };
                    ...
                    render() {
                        ...
                        if (i.hasData() || d) {
                            ...
                            i.minorTickInterval &&
                                ...
                                c.length &&
                                    ...
                                    b && (0 === i.min || i.single) && (u[-1] || (u[-1] = new n(i, -1, null, !0)), u[-1].render(-1))),
                                x &&
                                    c.forEach(function (n, a) {
                                        (e = void 0 !== c[a + 1] ? c[a + 1] + b : i.max - b),
                                            a % 2 == 0 &&
                                                ...
                                                (t = n + b),
                                                (f[n].options = { from: o ? o.lin2log(t) : t, to: o ? o.lin2log(e) : e, color: x, className: "highcharts-alternate-grid" }),
                                                f[n].render(),
                                                (f[n].isActive = !0));
                                    }),
                                i._addedPlotLB ||
                        ...
                        [u, g, f].forEach(function (t) {
                            ...
                            v && (v[v.isPlaced ? "animate" : "attr"]({ d: this.getLinePath(v.strokeWidth()) }), (v.isPlaced = !0), v[S ? "show" : "hide"](S)),
                            p && S && (p[p.isNew ? "attr" : "animate"](i.getTitlePosition(p)), (p.isNew = !1)),
                            m && m.enabled && i.stacking && i.stacking.renderStackTotals(),
                            (i.old = { len: i.len, max: i.max, min: i.min, transA: i.transA, userMax: i.userMax, userMin: i.userMin }),
                            (i.isDirty = !1),
                            M(this, "afterRender");
                    }
                    redraw() {
                    ...
                    drawCrosshair(t, e) {
                        let s = this.crosshair,
                            ...
                            l = this.cross,
                            d;
                        if ((M(this, "drawCrosshair", { e: t, point: e }), t || (t = this.cross && this.cross.e), s && !1 !== (y(e) || !o))) {
                            if (
                                (o ? y(e) && (a = E("colorAxis" !== this.coll ? e.crosshairPos : null, this.isXAxis ? e.plotX : this.len - e.plotY)) : (a = t && (this.horiz ? t.chartX - this.pos : this.len - t.chartY + this.pos)),
                                y(a) &&
                                    ((d = { value: e && (this.isXAxis ? e.x : E(e.stackY, e.y)), translatedValue: a }),
                                    r.polar && k(d, { isCrosshair: !0, chartX: t && t.chartX, chartY: t && t.chartY, point: e }),
                            ...
                            (h = this.categories && !this.isRadial),
                                l ||
                                    ((this.cross = l = r.renderer
                                        .path()
                                        .addClass("highcharts-crosshair highcharts-crosshair-" + (h ? "category " : "thin ") + (s.className || ""))
                                        .attr({ zIndex: E(s.zIndex, 2) })
                                        .add()),
                                    !r.styledMode &&
                                        (l.attr({ stroke: s.color || (h ? i.parse("#ccd3ff").setOpacity(0.25).get() : "#cccccc"), "stroke-width": E(s.width, 1) }).css({ "pointer-events": "none" }),
        ...
        i(e, "Core/Axis/DateTimeAxis.js", [e["Core/Globals.js"], e["Core/Utilities.js"]], function (t, e) {
            var i;
            let { composed: s } = t,
                { addEvent: o, getMagnitude: r, normalizeTickInterval: n, pushUnique: a, timeUnits: h } = e;
            return (
                (function (t) {
                    function e() {
                    ...
                    class h {
                        ...
                        getLogTickPositions(t, e, i, s) {
                            let o = this.axis,
                                ...
                                h = o.options,
                                l = [];
                            if ((s || (this.minorAutoInterval = void 0), t >= 0.5)) (t = Math.round(t)), (l = o.getLinearTickPositions(t, e, i));
                            else if (t >= 0.08) {
                                let o, r, n, a, h, d, c;
                                let p = Math.floor(e);
                                for (o = t > 0.3 ? [1, 2, 4] : t > 0.15 ? [1, 2, 4, 6, 8] : [1, 2, 3, 4, 5, 6, 7, 8, 9], r = p; r < i + 1 && !c; r++)
                                    for (n = 0, a = o.length; n < a && !c; n++) (h = this.log2lin(this.lin2log(r) * o[n])) > e && (!s || d <= i) && void 0 !== d && l.push(d), d > i && (c = !0), (d = h);
                            } else {
                ...
                (function (t) {
                    ...
                    function d(t, e, i) {
                        ...
                        let s = this.getPlotLinePath({ value: e, force: !0, acrossPanes: i.acrossPanes }),
                            ...
                            h = this.getPlotLinePath({ value: t, force: !0, acrossPanes: i.acrossPanes }),
                            l,
                            d = 1,
                            c;
                        if (h && s)
                            for (a && ((c = h.toString() === s.toString()), (d = 0)), l = 0; l < h.length; l += 2) {
                                ...
                                ("M" === t[0] || "L" === t[0]) &&
                                    ...
                                    ("M" === i[0] || "L" === i[0]) &&
                                    ("M" === n[0] || "L" === n[0]) &&
                                    (r && i[1] === t[1] ? ((i[1] += d), (n[1] += d)) : r || i[2] !== t[2] || ((i[2] += d), (n[2] += d)), o.push(["M", t[1], t[2]], ["L", e[1], e[2]], ["L", n[1], n[2]], ["L", i[1], i[2]], ["Z"])),
                                    (o.isFlat = c);
                            }
                        return o;
                    }
                    ...
                    t.compose = function t(o, n) {
                        return a(s, t) && ((e = o), r(n.prototype, { addPlotBand: i, addPlotLine: l, addPlotBandOrLine: h, getPlotBandPath: d, removePlotBand: c, removePlotLine: u, removePlotBandOrLine: p })), n;
                    };
                })(i || (i = {})),
                i
            );
        ...
        i(e, "Core/Axis/PlotLineOrBand/PlotLineOrBand.js", [e["Core/Axis/PlotLineOrBand/PlotLineOrBandAxis.js"], e["Core/Utilities.js"]], function (t, e) {
            ...
            class c {
                ...
                render() {
                    ...
                    if (
                        (!t.chart.styledMode &&
                            (C ? ((T.stroke = r || "#999999"), (T["stroke-width"] = d(e.width, 1)), e.dashStyle && (T.dashstyle = e.dashStyle)) : M && ((T.fill = r || "#e6e9ff"), x && ((T.stroke = e.borderColor), (T["stroke-width"] = x)))),
                        (p.zIndex = c),
                        (A += "-" + c),
                        (k = t.plotLinesAndBandsGroups[A]) ||
                            (t.plotLinesAndBandsGroups[A] = k = u
                                .g("plot-" + A)
                                .attr(p)
                                .add()),
                        ...
                        S = t.getPlotLinePath({ value: s?.log2lin(m) ?? m, lineWidth: v.strokeWidth(), acrossPanes: e.acrossPanes });
                    else {
                        if (!(o(f) && o(g))) return;
                    ...
                    return (
                        !this.eventsAdded &&
                            ...
                            (this.eventsAdded = !0)),
                        (w || !v.d) && S?.length ? v.attr({ d: S }) : v && (S ? (v.show(), v.animate({ d: S })) : v.d && (v.hide(), b && (this.label = b = b.destroy()))),
                        y && (o(y.text) || o(y.formatter)) && S?.length && t.width > 0 && t.height > 0 && !S.isFlat
                            ? ((y = h({ align: i && M && "center", x: i ? !M && 4 : 10, verticalAlign: !i && M && "middle", y: i ? (M ? 16 : 10) : M ? 6 : -4, rotation: i && !M && 90 }, y)), this.renderLabel(y, S, M, c))
                            : b && b.hide(),
                        this
                    );
                }
                renderLabel(t, e, o, r) {
                    ...
                    l ||
                        ((this.label = l = a
                            ...
                            .attr({ align: t.textAlign || t.align, rotation: t.rotation, class: "highcharts-plot-" + (o ? "band" : "line") + "-label" + (t.className || ""), zIndex: r })),
                        n.chart.styledMode || l.css(h({ fontSize: "0.8em", textOverflow: "ellipsis" }, t.style)),
                        l.add());
                    let d = e.xBounds || [e[0][1], e[1][1], o ? e[2][1] : e[0][1]],
                        c = e.yBounds || [e[0][2], e[1][2], o ? e[2][2] : e[0][2]],
                        p = s(d),
                        u = s(c);
                    if ((l.align(t, !1, { x: p, y: u, width: i(d) - p, height: i(c) - u }), !l.alignValue || "left" === l.alignValue)) {
        ...
        i(e, "Core/Tooltip.js", [e["Core/Templating.js"], e["Core/Globals.js"], e["Core/Renderer/RendererUtilities.js"], e["Core/Renderer/RendererRegistry.js"], e["Core/Utilities.js"]], function (t, e, i, s, o) {
            ...
            let { format: n } = t,
                ...
                { distribute: d } = i,
                { addEvent: c, clamp: p, css: u, discardElement: g, extend: f, fireEvent: m, isArray: x, isNumber: y, isString: b, merge: v, pick: S, pushUnique: k, splat: M, syncTimeout: C } = o;
            class w {
                constructor(t, e) {
                ...
                getAnchor(t, e) {
                    ...
                    let s = this.chart,
                        ...
                        n = s.plotTop,
                        a = s.plotLeft;
                    if (((t = M(t))[0].series && t[0].series.yAxis && !t[0].series.yAxis.options.reversedStacks && (t = t.slice().reverse()), this.followPointer && e))
                        void 0 === e.chartX && (e = o.normalize(e)), (i = [e.chartX - a, e.chartY - n]);
                ...
                getClassName(t, e, i) {
                    let s = this.options,
                        o = t.series,
                        r = o.options;
                    return [s.className, "highcharts-label", i && "highcharts-tooltip-header", e ? "highcharts-tooltip-box" : "highcharts-tooltip", !i && "highcharts-color-" + S(t.colorIndex, o.colorIndex), r && r.className]
                        .filter(b)
                        .join(" ");
                }
                getLabel() {
                    ...
                    if (!this.label) {
                        if (this.outside) {
                            ...
                            (this.container = n = e.doc.createElement("div")),
                                ...
                                u(n, { position: "absolute", top: "1px", pointerEvents: "none", zIndex: Math.max(this.options.style.zIndex || 0, ((t && t.zIndex) || 0) + 3) }),
                                (this.renderer = a = new i(n, 0, 0, t, void 0, void 0, a.styledMode));
                        }
                        if (
                            (r
                                ? (this.label = a.g("tooltip"))
                                : ((this.label = a.label("", 0, 0, o.shape, void 0, void 0, o.useHTML, void 0, "tooltip").attr({ padding: o.padding, r: o.borderRadius })),
                                  i ||
                                      this.label
                                          .attr({ fill: o.backgroundColor, "stroke-width": o.borderWidth || 0 })
                                          .css(o.style)
                                          .css({ pointerEvents: o.style.pointerEvents || (this.shouldStickOnContact() ? "auto" : "none") })),
                            t.outside)
                        ) {
                            let e = this.label,
                ...
                move(t, e, i, s) {
                    ...
                    f(n, { x: a ? (2 * n.x + t) / 3 : t, y: a ? (n.y + e) / 2 : e, anchorX: h ? void 0 : a ? (2 * n.anchorX + i) / 3 : i, anchorY: h ? void 0 : a ? (n.anchorY + s) / 2 : s }),
                        r.getLabel().attr(n),
                        r.drawTracker(),
                        a &&
                            (o.clearTimeout(this.tooltipTimeout),
                    ...
                    if (((this.distance = S(C.tooltipOptions.distance, 16)), !1 === k)) this.hide();
                        ...
                        if (this.split && this.allowShared) this.renderSplit(k, a);
                            ...
                            if ((e && r.isDirectTouch && ((t = e.chartX - i.plotLeft), (o = e.chartY - i.plotTop)), i.polar || !1 === C.options.clip || a.some((e) => r.isDirectTouch || e.series.shouldShowTooltip(t, o)))) {
                                let t = this.getLabel();
                                (!s.style.width || u) && t.css({ width: (this.outside ? this.getPlayingField() : i.spacingBox).width + "px" }),
                                    t.attr({ text: k && k.join ? k.join("") : k }),
                                    t.addClass(this.getClassName(h), !0),
                                    u || t.attr({ stroke: s.borderColor || h.color || C.color || "#666666" }),
                                    this.updatePosition({ plotX: y, plotY: v, negative: h.negative, ttBelow: h.ttBelow, h: f[2] || 0 });
                            } else {
                                this.hide();
                                return;
                            }
                ...
                renderSplit(t, e) {
                    let i = this,
                        ...
                        w = i.outside && "number" != typeof m ? h.documentElement.getBoundingClientRect() : { left: x, right: x + o, top: y, bottom: y + r },
                        T = i.getLabel(),
                    ...
                    function I(t, e, s, o, r = !0) {
                        let n, a;
                        return s ? ((n = P ? 0 : j), (a = p(t - o / 2, w.left, w.right - o - (i.outside ? L : 0)))) : ((n = e - D), (a = p((a = r ? t - o - k : t + k), r ? a : w.left, w.right))), { x: a, y: n };
                    }
                    b(t) && (t = [!1, t]);
                    let B = t.slice(0, e.length + 1).reduce(function (t, s, o) {
                        if (!1 !== s && "" !== s) {
                            let r = e[o - 1] || { isHeader: !0, plotX: e[0].plotX, plotY: n, series: {} },
                                h = r.isHeader,
                                l = h ? i : r.series,
                                d = (l.tt = (function (t, e, s) {
                                    ...
                                    if (!o) {
                                        ...
                                        v || ((t.fill = M.backgroundColor), (t["stroke-width"] = M.borderWidth ?? 1)),
                                            (o = A.label("", 0, 0, M[r ? "headerShape" : "shape"], void 0, void 0, M.useHTML)
                            ...
                            if ("number" == typeof m) {
                                ...
                                t.push({ align: C ? 0 : void 0, anchorX: f, anchorY: m, boxWidth: g, point: r, rank: S(s.rank, h ? 1 : 0), size: e, target: s.y, tt: d, x: s.x });
                            } else d.isActive = !1;
                        }
                        return t;
                    }, []);
                    ...
                    B.forEach(function (t) {
                        ...
                        B.forEach(function (t) {
                            let {
                                ...
                                a = { visibility: void 0 === r ? "hidden" : "inherit", x: e, y: (r || 0) + D, anchorX: s, anchorY: o };
                            if (i.outside && e < s) {
                                let t = L - R.left;
                ...
                tooltipFooterHeaderFormatter(t, e) {
                    ...
                    return (
                        m(this, "headerFormatter", a, function (e) {
                            r && !h && y(t.key) && (h = r.getXDateFormat(t.key, s.dateTimeLabelFormats)),
                                r &&
                                    h &&
                ...
                updatePosition(t) {
                    ...
                    r &&
                        ...
                        r.setSize(a + x, n + x, !1),
                        (1 !== c || 1 !== p) && (u(i, { transform: `scale(${c}, ${p})` }), (f *= c), (m *= p)),
                        (f += l - g.x),
                        (m += d - g.y)),
        ...
        i(e, "Core/Series/Point.js", [e["Core/Renderer/HTML/AST.js"], e["Core/Animation/AnimationUtilities.js"], e["Core/Defaults.js"], e["Core/Templating.js"], e["Core/Utilities.js"]], function (t, e, i, s, o) {
            let { animObject: r } = e,
                { defaultOptions: n } = i,
                { format: a } = s,
                { addEvent: h, defined: l, erase: d, extend: c, fireEvent: p, getNestedProperty: u, isArray: g, isFunction: f, isNumber: m, isObject: x, merge: y, objectEach: b, pick: v, syncTimeout: S, removeEvent: k, uniqueKey: M } = o;
            class C {
                ...
                applyOptions(t, e) {
                    ...
                    return (
                        ...
                        void 0 === this.x && i ? (void 0 === e ? (this.x = i.autoIncrement()) : (this.x = e)) : m(t.x) && i.options.relativeXValue && (this.x = i.autoIncrement(t.x)),
                ...
                destroy() {
                    if (!this.destroyed) {
                        ...
                        t.legendItem && i.legend.destroyItem(t),
                            o && (t.setState(), d(o, t), o.length || (i.hoverPoints = null)),
                            t === i.hoverPoint && t.onMouseOut(),
                            s && s.enabled ? (this.animateBeforeDestroy(), S(h, a.duration)) : h(),
                            i.pointCount--;
                    }
                    this.destroyed = !0;
                }
                ...
                firePointEvent(t, e, i) {
                    let s = this,
                        o = this.series,
                        r = o.options;
                    (r.point.events[t] || (s.options && s.options.events && s.options.events[t])) && s.importEvents(),
                        "click" === t &&
                            r.allowPointSelect &&
                            (i = function (t) {
                ...
                getGraphicalProps(t) {
                    ...
                    let s = this,
                        o = [],
                        r = { singular: [], plural: [] };
                    for ((t = t || { graphic: 1, dataLabel: 1 }).graphic && o.push("graphic", "connector"), t.dataLabel && o.push("dataLabel", "dataLabelPath", "dataLabelUpper"), i = o.length; i--; ) s[(e = o[i])] && r.singular.push(e);
                    return (
                ...
                optionsToObject(t) {
                    ...
                    if (m(t) || null === t) r[s[0]] = t;
                        ...
                        for (!i && t.length > o && ("string" == (n = typeof t[0]) ? (r.name = t[0]) : "number" === n && (r.x = t[0]), a++); h < o; )
                            (i && void 0 === t[a]) || (s[h].indexOf(".") > 0 ? C.prototype.setNestedProperty(r, t[a], s[h]) : (r[s[h]] = t[a])), a++, h++;
                ...
                resolveColor() {
                    ...
                    delete this.nonZonedColor,
                        t.options.colorByPoint
                            ? (i || ((s = (o = t.options.colors || t.chart.options.colors)[t.colorCounter]), (r = o.length)), (n = t.colorCounter), t.colorCounter++, t.colorCounter === r && (t.colorCounter = 0))
                ...
                update(t, e, i, s) {
                    ...
                    function d() {
                        ...
                        a && d && ((r.graphic = a.destroy()), delete r.hasMockGraphic),
                            x(t, !0) && (a && a.element && t && t.marker && void 0 !== t.marker.symbol && (r.graphic = a.destroy()), t?.dataLabels && r.dataLabel && (r.dataLabel = r.dataLabel.destroy())),
                            (o = r.index),
                            n.updateParallelArrays(r, o),
                            (l.data[o] = x(l.data[o], !0) || x(t, !0) ? r.options : v(t, l.data[o])),
                ...
                setState(e, i) {
                    ...
                    } else e && l && ((M = u.symbol || s.symbol), k && k.currentSymbol !== M && (k = k.destroy()), y && (k ? k[i ? "animate" : "attr"]({ x: y.x, y: y.y }) : M && ((s.stateMarkerGraphic = k = g.renderer.symbol(M, y.x, y.y, y.width, y.height).add(s.markerGroup)), (k.currentSymbol = M))), !g.styledMode && k && "inactive" !== this.state && k.attr(s.pointAttribs(this, e))), k && (k[e && this.isInside ? "show" : "hide"](), (k.element.point = this), k.addClass(this.getClassName(), !0));
                    let C = r.halo,
                        w = this.graphic || k,
                    ...
                    C && C.size && w && "hidden" !== T && !this.isCluster
                        ? (x || (s.halo = x = g.renderer.path().add(w.parentGroup)),
                          ...
                          x.attr({ class: "highcharts-halo highcharts-color-" + v(this.colorIndex, s.colorIndex) + (this.className ? " " + this.className : ""), visibility: T, zIndex: -1 }),
                          (x.point = this),
                          g.styledMode || x.attr(c({ fill: this.color || s.color, "fill-opacity": C.opacity }, t.filterUserAttributes(C.attributes || {}))))
        ...
        i(e, "Core/Pointer.js", [e["Core/Color/Color.js"], e["Core/Globals.js"], e["Core/Utilities.js"]], function (t, e, i) {
            ...
            let { parse: o } = t,
                ...
                { addEvent: h, attr: l, css: d, defined: c, extend: p, find: u, fireEvent: g, isNumber: f, isObject: m, objectEach: x, offset: y, pick: b, pushUnique: v, splat: S } = i;
            class k {
                ...
                destroy() {
                    ...
                    this.eventsToUnbind.forEach((t) => t()),
                        (this.eventsToUnbind = []),
                        !e.chartCount && (k.unbindDocumentMouseUp && (k.unbindDocumentMouseUp = k.unbindDocumentMouseUp()), k.unbindDocumentTouchEnd && (k.unbindDocumentTouchEnd = k.unbindDocumentTouchEnd())),
                ...
                getSelectionMarkerAttrs(t, e) {
                    ...
                    return (
                        g(this, "getSelectionMarkerAttrs", i, (i) => {
                            let s;
                            let { chart: o, mouseDownX: r = 0, mouseDownY: n = 0, zoomHor: a, zoomVert: h } = this,
                                l = i.attrs;
                            (l.x = o.plotLeft),
                                (l.y = o.plotTop),
                                (l.width = a ? 1 : o.plotWidth),
                                (l.height = h ? 1 : o.plotHeight),
                                a && ((s = t - r), (l.width = Math.abs(s)), (l.x = (s > 0 ? 0 : s) + r)),
                                h && ((s = e - n), (l.height = Math.abs(s)), (l.y = (s > 0 ? 0 : s) + n));
                        }),
                        i
                    );
                }
                drag(t) {
                    ...
                    if ((!f || !f.touch) && (p < s ? (p = s) : p > s + n && (p = s + n), u < r ? (u = r) : u > r + a && (u = r + a), (this.hasDragged = Math.sqrt(Math.pow(h - p, 2) + Math.pow(l - u, 2))), this.hasDragged > 10)) {
                        ...
                        (e.hasCartesianSeries || e.mapView) &&
                            ...
                            !c &&
                            !f &&
                            ((this.selectionMarker = f = e.renderer[n]()), f.attr({ class: "highcharts-selection-marker", zIndex: 7 }).add(), e.styledMode || f.attr({ fill: i.selectionMarkerFill || o("#334eff").setOpacity(0.25).get() })),
                            f && f.attr(a),
                ...
                getSelectionBox(t) {
                    ...
                    return (
                        g(this, "getSelectionBox", e, (e) => {
                            e.result = { x: t.attr ? +t.attr("x") : t.x, y: t.attr ? +t.attr("y") : t.y, width: t.attr ? t.attr("width") : t.width, height: t.attr ? t.attr("height") : t.height };
                        }),
                        e.result
                    );
                }
                drop(t) {
                    ...
                    if (this.selectionMarker) {
                        let { x: o, y: r, width: n, height: a } = this.getSelectionBox(this.selectionMarker),
                            h = { originalEvent: t, xAxis: [], yAxis: [], x: o, y: r, width: n, height: a },
                            l = !!i.mapView;
                        (this.hasDragged || s) &&
                            (i.axes.forEach(function (i) {
                                if (i.zoomEnabled && c(i.min) && (s || e[{ xAxis: "zoomX", yAxis: "zoomY" }[i.coll]]) && f(o) && f(r) && f(n) && f(a)) {
                                    let e = i.horiz,
                            ...
                            f(i.index) && (this.selectionMarker = this.selectionMarker.destroy()),
                            s && this.scaleGroups();
                    }
                ...
                getChartCoordinatesFromPoint(t, e) {
                    ...
                    if (s && o) {
                        let i = b(t.clientX, t.plotX),
                            n = t.plotY || 0;
                        return t.isNode && r && f(r.x) && f(r.y) && ((i = r.x), (n = r.y)), e ? { chartX: o.len + o.pos - n, chartY: s.len + s.pos - i } : { chartX: i + s.pos, chartY: n + o.pos };
                    }
                ...
                onContainerClick(t) {
                    ...
                    !e.cancelClick &&
                        (i && this.inClass(s.target, "highcharts-tracker")
                            ? (g(i.series, "click", p(s, { point: i })), e.hoverPoint && i.firePointEvent("click", s))
                            : (p(s, this.getCoordinates(s)), e.isInsidePlot(s.chartX - o, s.chartY - r, { visiblePlotOnly: !0 }) && g(e, "click", s)));
                }
                ...
                onContainerMouseMove(t) {
                    ...
                    this.setHoverChartIndex(t),
                        ...
                        !e.openMenu &&
                            (this.inClass(s.target, "highcharts-tracker") || e.isInsidePlot(s.chartX - e.plotLeft, s.chartY - e.plotTop, { visiblePlotOnly: !0 })) &&
                ...
                pinch(t) {
                    ...
                    r > 1 ? (e.initiated = !0) : f && (e.initiated = !1),
                        h && e.initiated && !d && !1 !== t.cancelable && t.preventDefault(),
                        ...
                        "touchstart" === t.type
                            ...
                            : s.length &&
                              (g(i, "touchpan", { originalEvent: t }, () => {
                                  m || (e.selectionMarker = m = p({ destroy: a, touch: !0 }, i.plotBox)), e.pinchTranslate(s, o, l, m, c, n), (e.hasPinched = h), e.scaleGroups(l, c);
                              }),
                ...
                pinchTranslateDirection(t, e, i, s, o, r, n, a) {
                    let h = this.chart,
                        ...
                        T;
                    b(),
                        (S = k) < f.min ? ((S = f.min), (T = !0)) : S + v > f.max && ((S = f.max - v), (T = !0)),
                        T ? ((C -= 0.8 * (C - n[l][0])), "number" == typeof w && (w -= 0.8 * (w - n[l][1])), b()) : (n[l] = [C, w]),
                        g || ((r[l] = k - u), (r[p] = v));
                ...
                runPointActions(t, e, i) {
                    ...
                    this.unDocMouseMove ||
                        ((this.unDocMouseMove = h(s.container.ownerDocument, "mousemove", function (t) {
                ...
                scaleGroups(t, e) {
                    ...
                    i.series.forEach(function (s) {
                        ...
                        s.group &&
                            ...
                            (s.group.attr(o), s.markerGroup && (s.markerGroup.attr(t || s.getPlotBox("marker")), s.markerGroup.clip(e ? i.clipRect : null)), s.dataLabelsGroup && s.dataLabelsGroup.attr(o));
                    }),
                ...
                setDOMEvents() {
                    ...
                    (t.onmousedown = this.onContainerMouseDown.bind(this)),
                        ...
                        this.eventsToUnbind.push(h(t, "mouseenter", this.onContainerMouseEnter.bind(this))),
                        this.eventsToUnbind.push(h(t, "mouseleave", this.onContainerMouseLeave.bind(this))),
                        k.unbindDocumentMouseUp || (k.unbindDocumentMouseUp = h(i, "mouseup", this.onDocumentMouseUp.bind(this)));
                    ...
                    for (; s && "BODY" !== s.tagName; )
                        this.eventsToUnbind.push(
                            ...
                            (s = s.parentElement);
                    e.hasTouch &&
                        (this.eventsToUnbind.push(h(t, "touchstart", this.onContainerTouchStart.bind(this), { passive: !1 })),
                        this.eventsToUnbind.push(h(t, "touchmove", this.onContainerTouchMove.bind(this), { passive: !1 })),
                        k.unbindDocumentTouchEnd || (k.unbindDocumentTouchEnd = h(i, "touchend", this.onDocumentTouchEnd.bind(this), { passive: !1 })));
                }
                ...
                touch(t, e) {
                    ...
                    this.setHoverChartIndex(),
                        1 === t.touches.length
                            ? ((t = this.normalize(t)),
                              o.isInsidePlot(t.chartX - o.plotLeft, t.chartY - o.plotTop, { visiblePlotOnly: !0 }) && !o.openMenu
                                  ? (e && this.runPointActions(t),
                                    "touchmove" === t.type && (i = !!(s = this.pinchDown)[0] && Math.sqrt(Math.pow(s[0].chartX - t.chartX, 2) + Math.pow(s[0].chartY - t.chartY, 2)) >= 4),
                                    b(i, !0) && this.pinch(t))
                                  : e && this.reset())
        ...
        i(e, "Core/Legend/Legend.js", [e["Core/Animation/AnimationUtilities.js"], e["Core/Templating.js"], e["Core/Globals.js"], e["Core/Series/Point.js"], e["Core/Renderer/RendererUtilities.js"], e["Core/Utilities.js"]], function (
            t,
            e,
            i,
            s,
            ...
            let { animObject: a, setAnimation: h } = t,
                ...
                { distribute: p } = o,
                { addEvent: u, createElement: g, css: f, defined: m, discardElement: x, find: y, fireEvent: b, isNumber: v, merge: S, pick: k, pushUnique: M, relativeLength: C, stableSort: w, syncTimeout: T } = r;
            class A {
                constructor(t, e) {
                    (this.allItems = []),
                        (this.initialItemY = 0),
                ...
                setOptions(t) {
                    let e = k(t.padding, 8);
                    (this.options = t),
                        this.chart.styledMode || ((this.itemStyle = t.itemStyle), (this.itemHiddenStyle = S(this.itemStyle, t.itemHiddenStyle))),
                ...
                colorizeItem(t, e) {
                    ...
                    if ((s?.[e ? "removeClass" : "addClass"]("highcharts-legend-item-hidden"), !this.chart.styledMode)) {
                        ...
                        o?.css(S(e ? this.itemStyle : s)), r?.attr(p({ stroke: d || t.color })), n && n.attr(p(c && n.isMarker ? t.pointAttribs() : { fill: t.color })), i?.attr(p({ fill: h || t.color, "fill-opacity": h ? 1 : l ?? 0.75 }));
                    }
                ...
                positionCheckboxes() {
                    ...
                    e &&
                        ...
                        this.allItems.forEach(function (o) {
                            let r;
                            let n = o.checkbox;
                            n && ((r = t + s + n.y + (this.scrollOffset || 0) + 3), f(n, { left: e.translateX + o.checkboxOffset + n.x - 20 + "px", top: r + "px", display: this.proximate || (r > t - 6 && r < t + i - 6) ? "" : "none" }));
                        }, this));
                }
                renderTitle() {
                    let t = this.options,
                    ...
                    i.text &&
                        (this.title ||
                            ((this.title = this.chart.renderer.label(i.text, e - 3, e - 4, void 0, void 0, void 0, t.useHTML, void 0, "legend-title").attr({ zIndex: 1 })),
                ...
                renderItem(t) {
                    ...
                    !y &&
                        ((e.group = s
                            .g("legend-item")
                            .addClass("highcharts-" + u.type + "-series highcharts-color-" + t.colorIndex + (x ? " " + x : "") + (p ? " highcharts-series-" + t.index : ""))
                            .attr({ zIndex: 1 })
                        ...
                        !this.baseline &&
                            ...
                            o.squareSymbol && ((this.symbolWidth = k(o.symbolWidth, Math.max(this.symbolHeight, 16))), (b = this.symbolWidth + a + d + (f ? 20 : 0)), c && y.attr("x", this.symbolWidth + a))),
                        ...
                        (i.styledMode || !h.width) && y.css({ width: (o.itemWidth || this.widthOption || i.spacingBox.width) - b + "px" }),
                        this.setText(t);
                    let v = y.getBBox(),
                ...
                layoutItem(t) {
                    let e = this.options,
                        ...
                        d = t.legendItem || {};
                    s && this.itemX - i + l > h && ((this.itemX = i), this.lastLineHeight && (this.itemY += n + this.lastLineHeight + r), (this.lastLineHeight = 0)),
                        (this.lastItemY = n + this.itemY + r),
                        (this.lastLineHeight = Math.max(o, this.lastLineHeight)),
                        (d.x = this.itemX),
                        (d.y = this.itemY),
                        s ? (this.itemX += l) : ((this.itemY += n + o + r), (this.lastLineHeight = o)),
                ...
                adjustMargins(t, e) {
                    let i = this.chart,
                        ...
                        o = this.getAlignment();
                    o &&
                        [/(lth|ct|rth)/, /(rtv|rm|rbv)/, /(rbh|cb|lbh)/, /(lbv|lm|ltv)/].forEach(function (r, n) {
                ...
                proximatePositions() {
                    ...
                    for (let o of (this.allItems.forEach(function (t) {
                        ...
                        t.yAxis &&
                            ...
                            t.points &&
                                (o = y(n ? t.points : t.points.slice(0).reverse(), function (t) {
                                    return v(t.plotY);
                                })),
                            (r = this.itemMarginTop + t.legendItem.label.getBBox().height + this.itemMarginBottom),
                            (h = t.yAxis.top - e.plotTop),
                            (a = t.visible ? (o ? o.plotY : t.yAxis.height) + (h - 0.3 * r) : h + t.yAxis.height),
                            i.push({ target: a, size: r, item: t }));
                    }, this),
                    p(i, e.plotHeight)))
                        (t = o.item.legendItem || {}), v(o.pos) && (t.y = e.plotTop - e.spacing[0] + o.pos);
                }
                render() {
                    let t = this.chart,
                        e = t.renderer,
                    ...
                    (this.itemX = s),
                        ...
                        this.renderTitle(),
                        w(o, (t, e) => ((t.options && t.options.legendIndex) || 0) - ((e.options && e.options.legendIndex) || 0)),
                        ...
                        d || (this.box = d = e.rect().addClass("highcharts-legend-box").attr({ r: i.borderRadius }).add(h)),
                        t.styledMode || d.attr({ stroke: i.borderColor, "stroke-width": i.borderWidth || 0, fill: i.backgroundColor || "none" }).shadow(i.shadow),
                        n > 0 && a > 0 && d[d.placed ? "animate" : "attr"](d.crisp.call({}, { x: 0, y: 0, width: n, height: a }, d.strokeWidth())),
                        h[r ? "show" : "hide"](),
                ...
                align(t = this.chart.spacingBox) {
                    ...
                    /(lth|ct|rth)/.test(this.getAlignment()) && e.titleOffset[0] > 0 ? (s += e.titleOffset[0]) : /(lbh|cb|rbh)/.test(this.getAlignment()) && e.titleOffset[2] > 0 && (s -= e.titleOffset[2]),
                        ...
                        this.group.align(S(i, { width: this.legendWidth, height: this.legendHeight, verticalAlign: this.proximate ? "top" : i.verticalAlign }), !0, t);
                }
                handleOverflow(t) {
                    let e = this,
                        i = this.chart,
                        ...
                        u = this.allItems,
                        g = function (t) {
                            "number" == typeof t ? S.attr({ height: t }) : S && ((e.clipRect = S.destroy()), e.contentGroup.clip()),
                            ...
                            ? ((this.clipHeight = m = Math.max(b - 20 - this.titleHeight - a, 0)),
                              ...
                              u.forEach((t, e) => {
                                  ...
                                  (!o || (i - p[o - 1] > m && (x || i) !== p[o - 1])) && (p.push(x || i), o++),
                                      ...
                                      e === u.length - 1 && i + s - p[o - 1] > m && i > p[o - 1] && (p.push(i), (y.pageIx = o)),
                                      i !== x && (x = i);
                              }),
                              S || ((S = e.clipRect = s.clipRect(0, a - 2, 9999, 0)), e.contentGroup.clip(S)),
                              g(m),
                              v ||
                              ...
                              e.scroll(0),
                              (t = b))
                            : v && (g(), (this.nav = v.destroy()), this.scrollGroup.attr({ translateY: 1 }), (this.clipHeight = 0)),
                        t
                    );
                }
                scroll(t, e) {
                    ...
                    if ((c > o && (c = o), c > 0)) {
                        void 0 !== e && h(e, i),
                            this.nav.attr({ translateX: d, translateY: r + this.padding + 7 + this.titleHeight, visibility: "inherit" }),
                            ...
                            [this.down, this.downTracker].forEach(function (t) {
                                t.attr({ x: 18 + this.pager.getBBox().width, class: c === o ? "highcharts-legend-nav-inactive" : "highcharts-legend-nav-active" });
                            }, this),
                            i.styledMode ||
                                (this.up.attr({ fill: 1 === c ? n.inactiveColor : n.activeColor }),
                                this.upTracker.css({ cursor: 1 === c ? "default" : "pointer" }),
                                this.down.attr({ fill: c === o ? n.inactiveColor : n.activeColor }),
                                this.downTracker.css({ cursor: c === o ? "default" : "pointer" })),
                ...
                createCheckboxForItem(t) {
                    (t.checkbox = g("input", { type: "checkbox", className: "highcharts-legend-checkbox", checked: t.selected, defaultChecked: t.selected }, this.options.itemCheckboxStyle, this.chart.container)),
                ...
                (function (t) {
                    function e(t, e, r) {
                        let n = (this.legendItem = this.legendItem || {}),
                            ...
                            v = 0;
                        if (
                            (a.styledMode || ((x["stroke-width"] = Math.min(h.lineWidth || 0, 24)), h.dashStyle ? (x.dashstyle = h.dashStyle) : "square" === h.linecap || (x["stroke-linecap"] = "round")),
                    ...
                    (t.areaMarker = function (t, i) {
                        ...
                        (t.rectangle = function (t, e) {
                            ...
                            i.symbol = this.chart.renderer
                                .rect(n ? (t.symbolWidth - r) / 2 : 0, t.baseline - r + 1, a, r, o(t.options.symbolRadius, r / 2))
                                .addClass("highcharts-point")
                                .attr({ zIndex: 3 })
                                .add(i.group);
                        });
        ...
        i(e, "Core/Series/SeriesDefaults.js", [], function () {
            return {
                ...
                marker: {
                    ...
                    lineWidth: 0,
                    radius: 4,
                    states: { normal: { animation: !0 }, hover: { animation: { duration: 150 }, enabled: !0, radiusPlus: 2, lineWidthPlus: 1 }, select: { fillColor: "#cccccc", lineColor: "#000000", lineWidth: 2 } },
                },
                point: { events: {} },
                dataLabels: {
                    animation: {},
            ...
            function (t, e, i, s, o, r, n, a, h, l) {
                ...
                class X {
                    ...
                    init(t, e) {
                        ...
                        let r = s.options,
                            n = !1 !== r.visible;
                        (s.linkedSeries = []), s.bindAxes(), A(s, { name: r.name, state: "", visible: n, selected: !0 === r.selected }), u(this, r);
                        let a = r.events;
                        ((a && a.click) || (r.point && r.point.events && r.point.events.click) || r.allowPointSelect) && (t.runTrackerClick = !0),
                            s.getColor(),
                            s.getSymbol(),
                            ...
                            r.dataSorting && r.dataSorting.enabled ? s.setDataSortingOptions() : s.points || s.data || s.setData(r.data, !1),
                            L(this, "afterInit");
                    }
                    is(t) {
                    ...
                    autoIncrement(t) {
                        ...
                        i &&
                            ((n = new o.Date(r)),
                            "day" === i ? o.set("Date", n, o.get("Date", n) + a) : "month" === i ? o.set("Month", n, o.get("Month", n) + a) : "year" === i && o.set("FullYear", n, o.get("FullYear", n) + a),
                            (a = n.getTime() - r)),
                        s && I(t))
                            ? r + a
                    ...
                    setDataSortingOptions() {
                        let t = this.options;
                        A(this, { requireSorting: !1, sorted: !1, enabledDataSorting: !0, allowDG: !1 }), k(t.pointRange) || (t.pointRange = 1);
                    }
                    setOptions(t) {
                        let e;
                        let i = this.chart,
                        ...
                        (this.tooltipOptions = R(p.tooltip, p.plotOptions.series?.tooltip, u?.tooltip, i.userOptions.tooltip, d.series?.tooltip, g.tooltip, n.tooltip)),
                            (this.stickyTracking = N(n.stickyTracking, g.stickyTracking, c.stickyTracking, (!!this.tooltipOptions.shared && !this.noSharedTooltip) || f.stickyTracking)),
                        ...
                        return (
                            (f.negativeColor || f.negativeFillColor) &&
                                !f.zones &&
                                ((e = { value: f[this.zoneAxis + "Threshold"] || f.threshold || 0, className: "highcharts-negative" }), a || ((e.color = f.negativeColor), (e.fillColor = f.negativeFillColor)), m.push(e)),
                            m.length && k(m[m.length - 1].value) && m.push(a ? {} : { color: this.color, fillColor: this.fillColor }),
                    ...
                    updateData(t, e) {
                        ...
                        if (
                            ...
                            t.forEach(function (t, e) {
                                let l;
                                let d = (k(t) && this.pointClass.prototype.optionsToObject.call({ series: this }, t)) || {},
                                    p = d.x,
                                    u = d.id;
                                u || I(p)
                                    ? (-1 === (l = this.findPointIndex(d, c)) || void 0 === l ? r.push(t) : o[l] && t !== i.data[l] ? (o[l].update(t, !1, null, !1), (o[l].touched = !0), n && (c = l + 1)) : o[l] && (o[l].touched = !0),
                                      (!a || e !== l || (s && s.enabled) || this.hasDerivedData) && (h = !0))
                                    : r.push(t);
                            }, this),
                            h)
                        )
                        ...
                        if ((l && l.enabled && (t = this.sortData(t)), h.options.chart.allowMutatingData && !1 !== s && C && n && !o.cropped && !o.hasGroupedData && o.visible && !o.boosted && (b = this.updateData(t, i)), !b)) {
                            if (
                                ...
                                if (I((k = o.getFirstValidPoint(t)))) for (x = 0; x < C; x++) (p[x] = this.autoIncrement()), (u[x] = t[x]);
                                    ...
                                    } else if ((m && ((v = m.indexOf("x")), (S = m.indexOf("y")), (v = v >= 0 ? v : 0), (S = S >= 0 ? S : 1)), 1 === k.length && (S = 0), v === S))
                                        for (x = 0; x < C; x++) (p[x] = this.autoIncrement()), (u[x] = t[x][S]);
                    ...
                    getProcessedData(t) {
                        let e = this,
                            ...
                            m = !1,
                            x = g.length;
                        i && ((p = (c = i.getExtremes()).min), (u = c.max), (m = !!(i.categories && !i.names.length))),
                            a &&
                                e.sorted &&
                                !r &&
                                (!o || x > o || e.forceCrop) &&
                                (g[x - 1] < p || g[0] > u ? ((g = []), (f = [])) : e.yData && (g[0] < p || g[x - 1] > u) && ((g = (h = this.cropData(e.xData, e.yData, p, u)).xData), (f = h.yData), (d = h.start), (l = !0)));
                    ...
                    generatePoints() {
                        ...
                        for (h && a && (this.options.keys = !1), g = 0; g < r; g++)
                            (p = n + g),
                                a
                                    ? (((u = new o(this, [i[g]].concat(G(s[g])))).dataGroup = this.groupMap[d + g]), u.dataGroup.options && ((u.options = u.dataGroup.options), A(u, u.dataGroup.options), delete u.dataLabels))
                                    : (u = f[p]) || void 0 === e[p] || (f[p] = u = new o(this, e[p], i[g])),
                    ...
                    getExtremes(t, e) {
                        ...
                        let v = t.length;
                        for (i && ((f = (h = i.getExtremes()).min), (m = h.max)), u = 0; u < v; u++)
                            if (
                                ((c = o[u]),
                                (l = (I((p = t[u])) || j(p)) && ((I(p) ? p > 0 : p.length) || !a)),
                                (d = e || this.getExtremesFromAll || this.options.getExtremesFromAll || this.cropped || !i || ((o[u + n] || c) >= f && (o[u - n] || c) <= m)),
                                l && d)
                            ) {
                            ...
                            (u = i.translate(y, !1, !1, !1, !0, h)),
                                ...
                                e &&
                                    ...
                                    b &&
                                        ...
                                        (a.percentage = k(a.y) && b.total ? (a.y / b.total) * 100 : void 0),
                                        (a.stackY = M),
                                ...
                                I(M) && void 0 !== a.plotX && (t = I((t = r.translate(M, !1, !0, !1, !0))) ? x(t) : void 0),
                                (a.plotY = t),
                                (a.isInside = this.isPointInside(a)),
                                (a.clientX = l ? S(i.translate(y, !1, !1, !1, !0, h)) : u),
                                (a.negative = (a.y || 0) < (d || 0)),
                                (a.category = N(s && s[a.x], a.x)),
                                a.isNull || !1 === a.visible || (void 0 !== g && (m = Math.min(m, Math.abs(u - g))), (g = u)),
                    ...
                    animate(t) {
                        ...
                        if (t && i) {
                            ...
                            if (a) a.attr("height", t.height);
                                ...
                                let i = { x: -99, y: -99, width: o ? e.plotWidth + 199 : 99, height: o ? 99 : e.plotHeight + 199 };
                                ...
                                if (c) {
                                    ...
                                    if (
                                        (!s &&
                                            ...
                                            ((i.graphic = s = h.renderer.symbol(t, a.x, a.y, a.width, a.height, n ? r : p).add(u)), this.enabledDataSorting && h.hasRendered && (s.attr({ x: i.startXPos }), (o = "animate"))),
                    ...
                    pointAttribs(t, e) {
                        ...
                        return (
                            ...
                            (e = e || "normal"),
                            (h = i.states[e] || {}),
                            (u = N((l = (o.states && o.states[e]) || {}).lineWidth, h.lineWidth, u + N(l.lineWidthPlus, h.lineWidthPlus, 0))),
                            (c = l.fillColor || h.fillColor || c),
                            { stroke: (p = l.lineColor || h.lineColor || p), "stroke-width": u, fill: c, opacity: (g = N(l.opacity, h.opacity, g)) }
                        );
                    }
                    destroy(t) {
                        let e, i, s;
                    ...
                    applyZones() {
                        let { area: t, chart: e, graph: i, zones: s, points: o, xAxis: r, yAxis: n, zoneAxis: a } = this,
                        ...
                        if (s.length && (i || t) && d && I(d.min)) {
                            ...
                            s.forEach((e) => {
                                ...
                                (f = s.reverse()),
                                    (m = o),
                                    h && (u(v), t && u(b)),
                                    a ? (a.animate({ d: v }), d?.animate({ d: b })) : ((a = e.clip = l.path(v)), t && (d = e.simpleClip = l.path(b))),
                                    i && e.graph?.clip(a),
                                    t && e.area?.clip(d);
                            });
                    ...
                    plotGroup(t, e, i, s, o) {
                        ...
                        return (
                            k(this.opacity) && !this.chart.styledMode && "inactive" !== this.state && (a.opacity = this.opacity),
                    ...
                    searchPoint(t, e) {
                        ...
                        return this.searchKDTree({ clientX: o ? i.len - t.chartY + i.pos : t.chartX - i.pos, plotY: o ? s.len - t.chartX + s.pos : t.chartY - s.pos }, e, t);
                    }
                    buildKDTree(t) {
                            ...
                            H(
                                function () {
                                    (e.kdTree = (function t(i, s, o) {
                                        let r, n;
                                        let a = i?.length;
                                        if (a) return (r = e.kdAxisArray[s % o]), i.sort((t, e) => (t[r] || 0) - (e[r] || 0)), { point: i[(n = Math.floor(a / 2))], left: t(i.slice(0, n), s + 1, o), right: t(i.slice(n + 1), s + 1, o) };
                    ...
                    pointPlacementToXValue() {
                        let { options: t, xAxis: e } = this,
                            i = t.pointPlacement;
                        return "between" === i && (i = e.reversed ? -0.5 : 0.5), I(i) ? i * (t.pointRange || e.pointRange) : 0;
                    }
                    isPointInside(t) {
                        ...
                        d
                            ...
                            : t.graph &&
                              ((t.tracker = d = n
                                  ...
                                  .add(t.group)),
                              o.styledMode || d.attr({ "stroke-linecap": "round", "stroke-linejoin": "round", stroke: l, fill: i ? l : "none", "stroke-width": t.graph.strokeWidth() + (i ? 0 : 2 * a) }),
                    ...
                    addPoint(t, e, i, s, o) {
                        ...
                        this.updateParallelArrays(g, "splice", [n, 0, 0]),
                            ...
                            i && (h[0] && h[0].remove ? h[0].remove(!1) : (h.shift(), this.updateParallelArrays(g, "shift"), p.shift())),
                    ...
                    update(t, e) {
                        ...
                        let i = this,
                            ...
                            g = !(
                                ...
                                t.joinBy ||
                                t.mapData ||
                                ["dataGrouping", "pointStart", "pointInterval", "pointIntervalUnit", "keys"].some((t) => i.hasOptionChanged(t))
                            );
                        (u = u || r),
                            g &&
                                (p.push(
                                ...
                                t.data && (t.dataSorting && A(i.options.dataSorting, t.dataSorting), this.setData(t.data, !1))),
                            (t = R(o, { index: void 0 === o.index ? i.index : o.index, pointStart: n?.series?.pointStart ?? o.pointStart ?? i.xData?.[0] }, !g && { data: i.options.data }, t, h)),
                        ...
                        if (
                            ...
                            for (let t of (!1 === (d = i.options).visible ? ((l.graphic = 1), (l.dataLabel = 1)) : (this.hasMarkerChanged(d, o) && (l.graphic = 1), i.hasDataLabels?.() || (l.dataLabel = 1)), this.points))
                                t && t.series && (t.resolveColor(), Object.keys(l).length && t.destroyElements(l), !1 === d.showInLegend && t.legendItem && s.legend.destroyItem(t));
        ...
        i(
            ...
            function (t, e, i, s, o, r, n, a, h, l, d, c, p, u) {
                ...
                class tt {
                    ...
                    init(t, e) {
                        W(this, "init", { args: arguments }, function () {
                            ...
                            (this.userOptions = z({}, t)),
                                ...
                                (this.axes = []),
                                (this.series = []),
                                (this.time = t.time && Object.keys(t.time).length ? new d(t.time) : r.time),
                    ...
                    isInsidePlot(t, e, i = {}) {
                        let { inverted: s, plotBox: o, plotLeft: r, plotTop: n, scrollablePlotBox: a } = this,
                            h = 0,
                            l = 0;
                        ...
                        if (!i.ignoreY && g.isInsidePlot) {
                            let t = (!s && i.axis && !i.axis.isXAxis && i.axis) || (d && (s ? d.xAxis : d.yAxis)) || { pos: n, len: 1 / 0 },
                    ...
                    applyDescription(t, e) {
                        ...
                        o && e && (this[t] = o = o.destroy()),
                            s &&
                                ...
                                this.styledMode || o.css(z("title" === t ? { fontSize: this.options.isStock ? "1em" : "1.2em" } : {}, s.style)),
                                (this[t] = o));
                    }
                    layOutTitles(t = !0) {
                        let e = [0, 0, 0],
                        ...
                        ["title", "subtitle", "caption"].forEach(function (t) {
                            ...
                            if (o) {
                                ...
                                o.align(z({ y: "bottom" === n ? t : a + t, height: h }, r), !1, "spacingBox"), r.floating || ("top" === n ? (e[0] = Math.ceil(e[0] + h)) : "bottom" === n && (e[2] = Math.ceil(e[2] + h)));
                            }
                        }, this),
                    ...
                    temporaryDisplay(t) {
                        ...
                        if (t) for (; e && e.style; ) e.hcOrigStyle && (D(e, e.hcOrigStyle), delete e.hcOrigStyle), e.hcOrigDetached && (k.body.removeChild(e), (e.hcOrigDetached = !1)), (e = e.parentNode);
                            ...
                            for (
                                ...
                                e &&
                                e.style &&
                                (k.body.contains(e) || e.parentNode || ((e.hcOrigDetached = !0), k.body.appendChild(e)),
                                ("none" === G(e, "display", !1) || e.hcOricDetached) &&
                                    ((e.hcOrigStyle = { display: e.style.display, height: e.style.height, overflow: e.style.overflow }),
                    ...
                    getContainer() {
                        ...
                        if (
                            ((this.renderer = new u(c, h, d, void 0, e.forExport, t.exporting && t.exporting.allowHTML, this.styledMode)),
                    ...
                    getMargins(t) {
                        ...
                        this.resetMargins(),
                            ...
                            s[2] && !E(i[2]) && (this.marginBottom = Math.max(this.marginBottom, s[2] + e[2])),
                    ...
                    setSize(t, e, i) {
                        ...
                        (s.isDirtyBox || n !== s.oldChartWidth || a !== s.oldChartHeight) &&
                            (s.styledMode || (r ? g : D)(s.container, { width: `${n + h}px`, height: `${a + l}px` }, r),
                            s.setChartSize(!0),
                            o.setSize(n, a, r),
                    ...
                    setChartSize(t) {
                        ...
                        (this.plotLeft = e = Math.round(this.plotLeft)),
                            ...
                            (this.plotHeight = o = Math.max(0, Math.round(h - i - this.marginBottom))),
                            (this.plotSizeX = r ? o : s),
                            (this.plotSizeY = r ? s : o),
                            (this.plotBorderWidth = l.plotBorderWidth || 0),
                            (this.spacingBox = n.spacingBox = { x: d[3], y: d[0], width: a - d[3] - d[1], height: h - d[0] - d[2] }),
                        ...
                        (this.clipBox = { x: u, y: g, width: Math.floor(this.plotSizeX - Math.max(p, c[1]) / 2 - u), height: Math.max(0, Math.floor(this.plotSizeY - Math.max(p, c[2]) / 2 - g)) }),
                            t ||
                    ...
                    drawChartBox() {
                        let t = this.options.chart,
                            ...
                            S,
                            k = "animate";
                        m || ((this.chartBackground = m = e.rect().addClass("highcharts-background").add()), (k = "attr")),
                            o
                                ? (b = v = m.strokeWidth())
                                : ((v = (b = t.borderWidth || 0) + (t.shadow ? 8 : 0)), (S = { fill: n || "none" }), (b || m["stroke-width"]) && ((S.stroke = t.borderColor), (S["stroke-width"] = b)), m.attr(S).shadow(t.shadow)),
                            m[k]({ x: v / 2, y: v / 2, width: i - v - (b % 2), height: s - v - (b % 2), r: t.borderRadius }),
                            (k = "animate"),
                            x || ((k = "attr"), (this.plotBackground = x = e.rect().addClass("highcharts-plot-background").add())),
                            x[k](u),
                            !o && (x.attr({ fill: a || "none" }).shadow(t.plotShadow), h && (r ? (h !== r.attr("href") && r.attr("href", h), r.animate(u)) : (this.plotBGImage = e.image(h, l, d, c, p).add()))),
                            g ? g.animate({ width: f.width, height: f.height }) : (this.clipRect = e.clipRect(f)),
                            (k = "animate"),
                            y || ((k = "attr"), (this.plotBorder = y = e.rect().addClass("highcharts-plot-border").attr({ zIndex: 1 }).add())),
                            o || y.attr({ stroke: t.plotBorderColor, "stroke-width": t.plotBorderWidth || 0, fill: "none" }),
                            y[k](y.crisp({ x: l, y: d, width: c, height: p }, -y.strokeWidth())),
                            (this.isDirtyBox = !1),
                            ...
                            i.forEach(function (t) {
                                ...
                                if (Y(i)) {
                                    ...
                                    (s = ":previous" === i ? e.series[t.index - 1] : e.get(i)) &&
                                        s.linkedParent !== t &&
                                        (s.linkedSeries.push(t), (t.linkedParent = s), s.enabledDataSorting && t.setDataSortingOptions(), (t.visible = $(t.options.visible, s.options.visible, t.visible)));
                                }
                            }),
                    ...
                    render() {
                        ...
                        this.drawChartBox(),
                            ...
                            this.seriesGroup || (this.seriesGroup = i.g("series-group").attr({ zIndex: 3 }).shadow(this.options.chart.seriesGroupShadow).add()),
                            this.renderSeries(),
                            this.addCredits(),
                    ...
                    destroy() {
                        ...
                        ["title", "subtitle", "chartBackground", "plotBackground", "plotBGImage", "plotBorder", "seriesGroup", "clipRect", "credits", "pointer", "rangeSelector", "legend", "resetZoomButton", "tooltip", "renderer"].forEach(
                            function (t) {
                                let i = e[t];
                    ...
                    warnIfA11yModuleNotLoaded() {
                        ...
                        !t ||
                            this.accessibility ||
                            (this.renderer.boxWrapper.attr({ role: "img", "aria-label": ((e && e.element.textContent) || "").replace(/</g, "&lt;") }),
                    ...
                    showLoading(t) {
                        let e = this,
                            ...
                            s = i.loading,
                            o = function () {
                                r && D(r, { left: e.plotLeft + "px", top: e.plotTop + "px", width: e.plotWidth + "px", height: e.plotHeight + "px" });
                            },
                            r = e.loadingDiv,
                            n = e.loadingSpan;
                        r || (e.loadingDiv = r = L("div", { className: "highcharts-loading highcharts-loading-hidden" }, null, e.container)),
                            n || ((e.loadingSpan = n = L("span", { className: "highcharts-loading-inner" }, null, r)), A(e, "redraw", o)),
                            (r.className = "highcharts-loading"),
                            p.setElementHTML(n, $(t, i.lang.loading, "")),
                            e.styledMode || (D(r, z(s.style, { zIndex: 10 })), D(n, s.labelStyle), e.loadingShown || (D(r, { opacity: 0, display: "" }), g(r, { opacity: s.style.opacity || 0.5 }, { duration: s.showDuration || 0 }))),
                            (e.loadingShown = !0),
                            o();
                    }
                    hideLoading() {
                    ...
                    update(t, e, i, s) {
                        ...
                        p &&
                            ...
                            ("inverted" in p || "polar" in p || "type" in p) && (a.propFromSeries(), (o = !0)),
                            "alignTicks" in p && (o = !0),
                            "events" in p && v(this, p),
                            V(p, function (t, e) {
                                -1 !== a.propsRequireUpdateSeries.indexOf("chart." + e) && (r = !0),
                                    -1 !== a.propsRequireDirtyBox.indexOf(e) && (a.isDirtyBox = !0),
                                    -1 === a.propsRequireReflow.indexOf(e) || ((a.isDirtyBox = !0), l || (n = !0));
                            }),
                            !a.styledMode && p.style && a.renderer.setStyle(a.options.chart.style || {})),
                            !a.styledMode && t.colors && (this.options.colors = t.colors),
                            t.time && (this.time === y && (this.time = new d(t.time)), U(!0, a.options.time, t.time)),
                            V(t, function (e, i) {
                                a[i] && "function" == typeof a[i].update ? a[i].update(e, !1) : "function" == typeof a[h[i]] ? a[h[i]](e) : "colors" !== i && -1 === a.collectionsWithUpdate.indexOf(i) && U(!0, a.options[i], t[i]),
                            ...
                            this.collectionsWithUpdate.forEach(function (e) {
                                t[e] &&
                                    (K(t[e]).forEach(function (t, s) {
                                        ...
                                        let r = E(t.id);
                                        r && (o = a.get(t.id)),
                                            !o && a[e] && (o = a[e][$(t.index, s)]) && ((r && E(o.options.id)) || o.options.isInternal) && (o = void 0),
                                            o && o.coll === e && (o.update(t, !1), i && (o.touched = !0)),
                                            !o && i && a.collectionsWithInit[e] && (a.collectionsWithInit[e][0].apply(a, [t].concat(a.collectionsWithInit[e][1] || []).concat([!1])).touched = !0);
                                    }),
                                    i &&
                        ...
                        n || (X(u) && u !== a.chartWidth) || (X(g) && g !== a.chartHeight) ? a.setSize(u, g, s) : $(e, !0) && a.redraw(s), W(a, "afterUpdate", { options: t, redraw: e, animation: s });
                    }
                    setSubtitle(t, e) {
                    ...
                    showResetZoom() {
                        ...
                        W(this, "beforeShowResetZoom", null, function () {
                            t.resetZoomButton = t.renderer.button(e.resetZoom, null, null, r, s).attr({ align: i.position.align, title: e.resetZoomTitle }).addClass("highcharts-reset-zoom").add().align(i.position, !1, o);
                        }),
                    ...
                    zoom(t) {
                        ...
                        !t || t.resetSelection
                            ...
                            : t.xAxis.concat(t.yAxis).forEach(function (t) {
                                  ...
                                  ((i[n ? "zoomX" : "zoomY"] && E(h) && E(l) && e.isInsidePlot(h - e.plotLeft, l - e.plotTop, { axis: r, ignoreX: a, ignoreY: a })) || !E(e.inverted ? h : l)) &&
                                ...
                                (e.panningState = b),
                                    e.isOrdinal ||
                                        ...
                                        e.series.length &&
                                            ...
                                            x >= S &&
                                            y <= k &&
                                            (e.setExtremes(x, y, !1, !1, { trigger: "pan" }), !s.resetZoomButton && x !== S && y !== k && a.match("y") && (s.showResetZoom(), (e.displayBtn = !1)), (i = !0)),
                                        (r[h] = n));
                            }),
                                V(r, (t, e) => {
                                    s[e] = t;
                ...
                return (
                    z(tt.prototype, {
                        callbacks: [],
                        collectionsWithInit: { xAxis: [tt.prototype.addAxis, [!0]], yAxis: [tt.prototype.addAxis, [!1]], series: [tt.prototype.addSeries] },
        ...
        i(e, "Extensions/ScrollablePlotArea.js", [e["Core/Animation/AnimationUtilities.js"], e["Core/Globals.js"], e["Core/Renderer/RendererRegistry.js"], e["Core/Utilities.js"]], function (t, e, i, s) {
            let { stop: o } = t,
                { composed: r } = e,
                { addEvent: n, createElement: a, css: h, defined: l, extend: d, merge: c, pick: p, pushUnique: u } = s;
            function g() {
                let t;
                let { axisOffset: e, chartWidth: s, chartHeight: r, container: l, plotHeight: d, plotLeft: c, plotTop: u, plotWidth: g, scrollablePixelsX: f = 0, scrollablePixelsY: m = 0, scrollingContainer: x } = this,
                    y = !this.fixedDiv,
                ...
                C
                    ? C.setSize(s, r)
                    : ((this.fixedDiv = a("div", { className: "highcharts-fixed" }, { position: "absolute", overflow: "hidden", pointerEvents: "none", zIndex: (b.style?.zIndex || 0) + 2, top: 0 }, void 0, !0)),
                      ...
                      (this.scrollableMask = C.path()
                          .attr({ fill: b.backgroundColor || "#fff", "fill-opacity": p(v.opacity, 0.85), zIndex: -1 })
                    ...
                    (this.scrollableDirty || y) && ((this.scrollableDirty = !1), this.moveFixedElements());
                let w = s + f,
                    T = r + m;
                o(this.container),
                    h(l, { width: `${w}px`, height: `${T}px` }),
                    this.renderer.boxWrapper.attr({ width: w, height: T, viewBox: [0, 0, w, T].join(" ") }),
                    this.chartBackground?.attr({ width: w, height: T }),
                    x && (h(x, { width: `${this.chartWidth}px`, height: `${this.chartHeight}px` }), y && (S && (x.scrollLeft = f * S), k && (x.scrollTop = m * k)));
                let A = u - e[0] - 1,
                    P = c - e[3] - 1,
                    L = u + d + e[2] + 1,
                    O = c + g + e[1] + 1,
                    ...
                    E = u + d - m;
                (t = f
                    ? [["M", 0, A], ["L", c - 1, A], ["L", c - 1, L], ["L", 0, L], ["Z"], ["M", D, A], ["L", s, A], ["L", s, L], ["L", D, L], ["Z"]]
                    : m
                    ? [["M", P, 0], ["L", P, u - 1], ["L", O, u - 1], ["L", O, 0], ["Z"], ["M", P, E], ["L", P, r], ["L", O, r], ["L", O, E], ["Z"]]
                    : [["M", 0, 0]]),
            ...
            function f() {
                ...
                for (let o of (this.scrollablePixelsX && !this.inverted
                    ...
                    ? (t = ".highcharts-xaxis")
                    : this.scrollablePixelsY && this.inverted && (t = ".highcharts-yaxis"),
                t && s.push(`${t}:not(.highcharts-radial-axis)`, `${t}-labels:not(.highcharts-radial-axis-labels)`),
                s))
            ...
            function m() {
                ...
                this.scrollablePixelsX && (e.overflowX = "auto"),
                    ...
                    (this.scrollingParent = a("div", { className: "highcharts-scrolling-parent" }, { position: "relative" }, this.renderTo)),
                    (this.scrollingContainer = a("div", { className: "highcharts-scrolling" }, e, this.scrollingParent)),
                    ...
                    (this.innerContainer = a("div", { className: "highcharts-inner-container" }, null, this.scrollingContainer)),
            ...
            function y(t) {
                ...
                if (
                    ...
                    (r
                        ? ((this.scrollablePixelsX = e = Math.max(0, r - this.chartWidth)),
                          e &&
                        ...
                        : n &&
                          ((this.scrollablePixelsY = i = Math.max(0, n - this.chartHeight)),
                          l(i) &&
                              ((this.scrollablePlotBox = this.renderer.scrollablePlotBox = c(this.plotBox)),
                              (this.plotBox.height = this.plotHeight += i),
                              this.inverted ? (this.clipBox.width += i) : (this.clipBox.height += i),
            ...
            return {
                compose: function t(e, i, s) {
                    u(r, t) && (n(e, "afterInit", x), d(i.prototype, { applyFixed: g, moveFixedElements: f, setUpScrolling: m }), n(i, "afterSetChartSize", y), n(i, "render", b), n(s, "show", v));
                },
            };
        }),
        i(e, "Core/Axis/Stacking/StackItem.js", [e["Core/Templating.js"], e["Core/Series/SeriesRegistry.js"], e["Core/Utilities.js"]], function (t, e, i) {
            let { format: s } = t,
                { series: o } = e,
                { destroyObjectProperties: r, fireEvent: n, isNumber: a, pick: h } = i;
            return class {
                constructor(t, e, i, s, o) {
                    ...
                    (this.options = e = e || {}),
                        ...
                        (this.leftCliff = 0),
                        (this.rightCliff = 0),
                        (this.alignOptions = { align: e.align || (r ? (a ? "left" : "right") : "center"), verticalAlign: e.verticalAlign || (r ? "middle" : a ? "bottom" : "top"), y: e.y, x: e.x }),
                ...
                setOffset(t, e, i, s, r, l) {
                    let { alignOptions: d, axis: c, label: p, options: u, textAlign: g } = this,
                        f = c.chart,
                        m = this.getStackBox({ xOffset: t, width: e, boxBottom: i, boxTop: s, defaultX: r, xAxis: l }),
                        { verticalAlign: x } = d;
                    if (p && m) {
                        let t = p.getBBox(),
                            e = p.padding,
                        ...
                        (m.x -= r),
                            (m.y -= n),
                            p.align(d, !1, m),
                            (s = f.isInsidePlot(p.alignAttr.x + d.x + r, p.alignAttr.y + d.y + n)) || (i = !1),
                            i && o.prototype.justifyDataLabel.call(c, p, d, p.alignAttr, t, m),
                            p.attr({ x: p.alignAttr.x, y: p.alignAttr.y, rotation: u.rotation, rotationOriginX: t.width / 2, rotationOriginY: t.height / 2 }),
                ...
                getStackBox(t) {
                    let e = this.axis,
                        i = e.chart,
                        { boxTop: s, defaultX: o, xOffset: r, width: n, boxBottom: l } = t,
                        ...
                        m = i.inverted,
                        x = this.isNegative;
                    return m ? { x: (x ? c : c - f) - i.plotLeft, y: p.height - u - n, width: f, height: n } : { x: u + p.transB - i.plotLeft, y: (x ? c - f : c) - i.plotTop, width: n, height: f };
                }
            };
        }),
        i(
            ...
            [e["Core/Animation/AnimationUtilities.js"], e["Core/Axis/Axis.js"], e["Core/Globals.js"], e["Core/Series/SeriesRegistry.js"], e["Core/Axis/Stacking/StackItem.js"], e["Core/Utilities.js"]],
            function (t, e, i, s, o, r) {
                ...
                let { getDeferredAnimation: a } = t,
                    ...
                    { addEvent: d, correctFloat: c, defined: p, destroyObjectProperties: u, fireEvent: g, isArray: f, isNumber: m, objectEach: x, pick: y, pushUnique: b } = r;
                function v() {
                    let t = this.inverted;
                    this.axes.forEach((t) => {
                ...
                function M(t, e, i, s) {
                    return !p(t) || t.x !== e || (s && t.stackKey !== s) ? (t = { x: e, index: 0, key: s, stackKey: s }) : t.index++, (t.key = [i, e, t.index].join(",")), t;
                }
                function C() {
                    let t;
                    let e = this,
                ...
                function A(t, e) {
                    ...
                    for (P.stacksTouched += 1, l = 0; l < v; l++) {
                        (d = m[l]),
                            ...
                            L[a][d] || (O[a]?.[d] ? ((L[a][d] = O[a][d]), (L[a][d].total = null)) : (L[a][d] = new o(t, t.options.stackLabels, !!s, d, C))),
                            (r = L[a][d]),
                            null !== u
                                ? ((r.points[h] = r.points[this.index] = [y(r.cumulative, M)]),
                                  p(r.cumulative) || (r.base = h),
                                  (r.touched = P.stacksTouched),
                                  i.index > 0 && !1 === this.singleStacks && (r.points[h][0] = r.points[this.index + "," + d + ",0"][0]))
                                : (delete r.points[h], delete r.points[this.index]);
                        let e = r.total || 0;
                        "percent" === g
                            ? ((n = s ? w : T), (e = A && L[n]?.[d] ? ((n = L[n][d]).total = Math.max(n.total || 0, e) + Math.abs(u) || 0) : c(e + (Math.abs(u) || 0))))
                            : "group" === g
                            ? (f(u) && (u = u[0]), null !== u && e++)
                            : (e = c(e + (u || 0))),
                            "group" === g ? (r.cumulative = (e || 1) - 1) : (r.cumulative = c(y(r.cumulative, M) + (u || 0))),
                            (r.total = e),
                            null !== u && (r.points[h].push(r.cumulative), (b[l] = r.cumulative), (r.hasValidPoints = !0));
                    }
                ...
                class P {
                    ...
                    renderStackTotals() {
                        let t = this.axis,
                            ...
                            r = a(e, o || !1),
                            n = (this.stackTotalGroup = this.stackTotalGroup || i.g("stack-labels").attr({ zIndex: 6, opacity: 0 }).add());
            ...
            class n extends t {
                drawGraph() {
                    ...
                    [this, ...this.zones].forEach((s, n) => {
                        ...
                        h
                            ? ((h.endX = this.preventGraphAnimation ? null : e.xMap), h.animate({ d: e }))
                            : e.length &&
                              (s.graph = h = this.chart.renderer
                                  .path(e)
                                  .addClass("highcharts-graph" + (n ? ` highcharts-zone-graph-${n - 1} ` : " ") + ((n && s.className) || ""))
                                  .attr({ zIndex: 1 })
                                  .add(this.group)),
                            h &&
                                !i &&
                                ((a = { stroke: (!n && t.lineColor) || s.color || this.color || "#cccccc", "stroke-width": t.lineWidth || 0, fill: (this.fillGraph && this.color) || "none" }),
                                d ? (a.dashstyle = d) : "square" !== t.linecap && (a["stroke-linecap"] = a["stroke-linejoin"] = "round"),
                                h[l](a).shadow(n < 2 && t.shadow && o({ filterUnits: "userSpaceOnUse" }, r(t.shadow) ? t.shadow : {}))),
                ...
                getGraphPath(t, e, i) {
                    ...
                    return (
                        ...
                        (t = this.getValidPoints(t, !1, !(r.connectNulls && !e && !i))).forEach(function (d, c) {
                            let p;
                            let u = d.plotX,
                                g = d.plotY,
                                f = t[c - 1],
        ...
        i(e, "Series/Area/AreaSeries.js", [e["Core/Color/Color.js"], e["Core/Series/SeriesRegistry.js"], e["Core/Utilities.js"]], function (t, e, i) {
                ...
                drawGraph() {
                    ...
                    [this, ...this.zones].forEach((i, s) => {
                        let o = {},
                            ...
                            a = n ? "animate" : "attr";
                        n
                            ? ((n.endX = this.preventGraphAnimation ? null : t.xMap), n.animate({ d: t }))
                            : ((o.zIndex = 0),
                              ((n = i.area = this.chart.renderer
                                  .path(t)
                                  .addClass("highcharts-area" + (s ? ` highcharts-zone-area-${s - 1} ` : " ") + ((s && i.className) || ""))
                                  .add(this.group)).isArea = !0)),
                            this.chart.styledMode || ((o.fill = r || i.color || this.color), (o["fill-opacity"] = r ? 1 : e.fillOpacity ?? 0.75), n.css({ pointerEvents: this.stickyTracking ? "none" : "auto" })),
                            n[a](o),
                            (n.startX = t.xMap),
                ...
                getGraphPath(t) {
                    ...
                    let r = o.prototype.getGraphPath,
                        ...
                        x = function (i, s, o) {
                            let r = t[i],
                                ...
                                y,
                                b = !0;
                            m || h ? ((x = (h ? n[0] : n[1]) + m), (y = n[0] + m), (b = !!h)) : !a && t[s] && t[s].isNull && (x = y = g),
                                void 0 !== x && (c.push({ plotX: e, plotY: null === x ? f : l.getThreshold(x), isNull: b, isCliff: !0 }), d.push({ plotX: e, plotY: null === y ? f : l.getThreshold(y), doCurve: !1 }));
                        };
                    ...
                    for (let o = 0, r = t.length; o < r; ++o)
                        a || (t[o].leftCliff = t[o].rightCliff = t[o].leftNull = t[o].rightNull = void 0),
                            ...
                            (i && !m) || (m || x(o, o - 1, "left"), (i && !a && m) || (c.push(t[o]), d.push({ x: o, plotX: e, plotY: s })), m || x(o, o + 1, "right"));
                    ...
                    if (((t = t || this.points), this.options.stacking)) {
                        ...
                        s.forEach(function (t, a) {
                            ...
                            if (l[t] && !l[t].isNull)
                                ...
                                (f = h(f, 0)), (f = r.translate(f, 0, 1, 0, 1)), i.push({ isNull: !0, plotX: o.translate(t, 0, 0, 0, 1), x: t, plotY: f, yBottom: f });
                            }
                        });
                    }
                    return i;
            ...
            return (l.defaultOptions = n(o.defaultOptions, { threshold: 0, legendSymbol: "areaMarker" })), r(l.prototype, { singleStacks: !1 }), e.registerSeriesType("area", l), l;
        }),
                ...
                getPointSpline(t, e, i) {
                    ...
                    if (p(d) && p(c)) {
                        ...
                        (s = (1.5 * h + t) / 2.5),
                            ...
                            (r += u),
                            (a += u),
                            r > i && r > l ? ((r = Math.max(i, l)), (a = 2 * l - r)) : r < i && r < l && ((r = Math.min(i, l)), (a = 2 * l - r)),
                            a > p && a > l ? ((a = Math.max(p, l)), (r = 2 * l - a)) : a < p && a < l && ((a = Math.min(p, l)), (r = 2 * l - a)),
                            (e.rightContX = n),
                            (e.rightContY = a),
        ...
        i(e, "Series/AreaSpline/AreaSplineSeries.js", [e["Series/Spline/SplineSeries.js"], e["Core/Series/SeriesRegistry.js"], e["Core/Utilities.js"]], function (t, e, i) {
            let {
                ...
                { extend: r, merge: n } = i;
            class a extends t {}
            return (a.defaultOptions = n(t.defaultOptions, s.defaultOptions)), r(a.prototype, { getGraphPath: o.getGraphPath, getStackPoints: o.getStackPoints, drawGraph: o.drawGraph }), e.registerSeriesType("areaspline", a), a;
        }),
        ...
        i(
            ...
            [e["Core/Animation/AnimationUtilities.js"], e["Core/Color/Color.js"], e["Series/Column/ColumnSeriesDefaults.js"], e["Core/Globals.js"], e["Core/Series/Series.js"], e["Core/Series/SeriesRegistry.js"], e["Core/Utilities.js"]],
            function (t, e, i, s, o, r, n) {
                let { animObject: a } = t,
                    { parse: h } = e,
                    { hasTouch: l, noop: d } = s,
                    { clamp: c, defined: p, extend: u, fireEvent: g, isArray: f, isNumber: m, merge: x, pick: y, objectEach: b, relativeLength: v } = n;
                class S extends o {
                    animate(t) {
                        let e, i;
                        let s = this,
                        ...
                        t
                            ? ((l.scaleY = 0.001), (i = c(o.toPixels(n.threshold), r, r + o.len)), h ? (l.translateX = i - o.len) : (l.translateY = i), s.clipBox && s.setClip(), s.group.attr(l))
                        ...
                        !1 === e.grouping
                            ...
                            : t.chart.series.forEach(function (e) {
                                  ...
                                  e.type === t.type &&
                                      ...
                                      s.len === o.len &&
                                      s.pos === o.pos &&
                                      (r.stacking && "group" !== r.stacking ? (void 0 === n[(a = e.stackKey)] && (n[a] = h++), (i = n[a])) : !1 !== r.grouping && (i = h++), (e.columnIndex = i));
                              });
                        ...
                        e.inverted && (S -= 0.5),
                            ...
                            t.points.forEach(function (s) {
                                ...
                                l &&
                                    Math.abs(w) < l &&
                                    ((w = l),
                                    (M = (!a.reversed && !s.negative) || (a.reversed && s.negative)),
                                    m(h) && m(b) && s.y === h && b <= h && (a.min || 0) < h && (x !== b || (a.max || 0) <= h) && ((M = !M), (s.negative = !s.negative)),
                                    (C = Math.abs(C - S) > l ? o - l : S - (M ? l : 0))),
                                    p(s.options.pointWidth) && (A -= Math.round(((T = P = Math.ceil(s.options.pointWidth)) - u) / 2)),
                                    i.centerInCategory && !i.stacking && (A = t.adjustForMissingColumns(A, T, s, d)),
                                    (s.barX = A),
                                    (s.pointWidth = T),
                                    (s.tooltipPos = e.inverted
                                        ? [c(a.len + a.pos - e.plotLeft - k, a.pos - e.plotLeft, a.len + a.pos - e.plotLeft), n.len + n.pos - e.plotTop - A - P / 2, w]
                                        : [n.left - e.plotLeft + A + P / 2, c(k + a.pos - e.plotTop, a.pos - e.plotTop, a.len + a.pos - e.plotTop), w]),
                                    (s.shapeType = t.pointClass.prototype.shapeType || "roundedRect"),
                                    (s.shapeArgs = t.crispCol(A, s.isNull ? S : C, P, s.isNull ? 0 : w));
                            }),
                    ...
                    pointAttribs(t, e) {
                        ...
                        t && this.zones.length && ((a = t.getZone()), (d = t.options.color || (a && (a.color || t.nonZonedColor)) || this.color), a && ((c = a.borderColor || c), (p = a.dashStyle || p), (u = a.borderWidth || u))),
                            e &&
                                t &&
                                ((l = (n = x(i.states[e], (t.options.states && t.options.states[e]) || {})).brightness),
                        ...
                        t.forEach(function (t) {
                            ...
                            m(a) && null !== t.y
                                ? ((e = t.shapeArgs),
                                  ...
                                  !h && ((t.graphic = h = r[t.shapeType](e).add(t.group || i.group)), h && i.enabledDataSorting && s.hasRendered && s.pointCount < n && (h.attr({ x: t.startXPos }), (l = !0), (d = "animate"))),
                                  h && l && h[d](x(e)),
                                  s.styledMode || h[d](i.pointAttribs(t, t.selected && "select")).shadow(!1 !== t.allowShadow && o.shadow),
                                  h && (h.addClass(t.getClassName(), !0), h.attr({ visibility: t.visible ? "inherit" : "hidden" })))
                ...
                return (S.defaultOptions = x(o.defaultOptions, i)), u(S.prototype, { directTouch: !0, getSymbol: d, negStacks: !0, trackerGroups: ["group", "dataLabelsGroup"] }), r.registerSeriesType("column", S), S;
            }
        ),
        i(e, "Core/Series/DataLabel.js", [e["Core/Animation/AnimationUtilities.js"], e["Core/Templating.js"], e["Core/Globals.js"], e["Core/Utilities.js"]], function (t, e, i, s) {
            ...
            let { getDeferredAnimation: r } = t,
                { format: n } = e,
                { composed: a } = i,
                { defined: h, extend: l, fireEvent: d, isArray: c, isString: p, merge: u, objectEach: g, pick: f, pInt: m, pushUnique: x, splat: y } = s;
            return (
                (function (t) {
                    function e() {
                    ...
                    function i(t, e, i, s, o) {
                        let r = this,
                            ...
                            k =
                                ...
                                !1 !== t.visible &&
                                h(c) &&
                                (t.series.forceDL || (d && !S) || m || (f(i.inside, !!this.options.stacking) && s && n.isInsidePlot(c, a ? s.x + 1 : s.y + s.height - 1, { inverted: a, paneCoordinates: !0, series: r }))),
                            M = t.pos();
                        if (k && M) {
                            u && e.attr({ align: g });
                            let t = e.getBBox(!0),
                            ...
                            if (
                                ...
                                (s = l({ x: M[0], y: Math.round(M[1]), width: 0, height: 0 }, s)),
                                l(i, { width: t.width, height: t.height }),
                                u
                                    ? ((S = !1),
                                      (b = n.renderer.rotCorr(y, u)),
                                      (v = { x: s.x + (i.x || 0) + s.width / 2 + b.x, y: s.y + (i.y || 0) + { top: 0, middle: 0.5, bottom: 1 }[i.verticalAlign] * s.height }),
                                      (a = [t.x - Number(e.attr("x")), t.y - Number(e.attr("y"))]),
                                      x(v),
                                      e[o ? "attr" : "animate"](v))
                                ...
                                let { x: e, y: i } = v;
                                (e += a[0]), (i += a[1]), (k = n.isInsidePlot(e, i, { paneCoordinates: !0, series: r }) && n.isInsidePlot(e + t.width, i + t.height, { paneCoordinates: !0, series: r }));
                            }
                    ...
                    function b(t) {
                        ...
                        let i = this,
                            ...
                            o = i.options,
                            a = s.renderer,
                            { backgroundColor: l, plotBackgroundColor: c } = s.options.chart,
                                ...
                                t.forEach((t) => {
                                    ...
                                    y(S(x, t.dlOptions || t.options?.dataLabels)).forEach((l, d) => {
                                        let c =
                                            ...
                                            { backgroundColor: x, borderColor: y, distance: b, style: v = {} } = l,
                                            S,
                                            k,
                                            M,
                                            C,
                                        ...
                                        if (
                                            (c &&
                                                ...
                                                (S = t.getLabelConfig()),
                                                (M = h(k) ? n(k, S, s) : (l[t.formatPrefix + "Formatter"] || l.formatter).call(S, l)),
                                                (C = l.rotation),
                                                !s.styledMode &&
                                                    ((v.color = f(l.color, v.color, p(i.color) ? i.color : void 0, "#000000")),
                                                    "contrast" === v.color
                                                        ? ("none" !== x && (P = x),
                                                          (t.contrastColor = a.getContrast(("auto" !== P && P) || t.color || i.color)),
                                                          (v.color = P || (!h(b) && l.inside) || 0 > m(b || 0) || o.stacking ? t.contrastColor : u))
                                                        : delete t.contrastColor,
                                                    o.cursor && (v.cursor = o.cursor)),
                                                (w = { r: l.borderRadius || 0, rotation: C, padding: l.padding, zIndex: 1 }),
                                                s.styledMode || ((w.fill = "auto" === x ? t.color : x), (w.stroke = "auto" === y ? t.color : y), (w["stroke-width"] = l.borderWidth)),
                                                g(w, (t, e) => {
                                                    void 0 === t && delete w[e];
                                                })),
                                            !T || (c && h(M) && !!T.div == !!l.useHTML && ((T.rotation && l.rotation) || T.rotation === l.rotation)) || ((T = void 0), (A = !0)),
                                            c &&
                                                h(M) &&
                                                (T
                                                    ? (w.text = M)
                                                    : (T = C ? a.text(M, 0, 0, l.useHTML).addClass("highcharts-data-label") : a.label(M, 0, 0, l.shape, void 0, void 0, l.useHTML, void 0, "data-label")) &&
                                                      T.addClass(" highcharts-data-label-color-" + t.colorIndex + " " + (l.className || "") + (l.useHTML ? " highcharts-tracker" : "")),
                                                T))
                                        ) {
                                            (T.options = l), T.attr(w), s.styledMode || T.css(v).shadow(l.shadow);
                                            let o = l[t.formatPrefix + "TextPath"] || l.textPath;
                                            o && !l.useHTML && (T.setTextPath(t.getDataLabelPath?.(T) || t.graphic, o), t.dataLabelPath && !o.enabled && (t.dataLabelPath = t.dataLabelPath.destroy())),
                                                T.added || T.add(e),
                    ...
                    function v(t, e, i, s, o, r) {
                        let n = this.chart,
                            ...
                            u;
                        return (
                            (p = (i.x || 0) + l) < 0 && ("right" === a && d >= 0 ? ((e.align = "left"), (e.inside = !0)) : (d -= p), (u = !0)),
                            (p = (i.x || 0) + s.width - l) > n.plotWidth && ("left" === a && d <= 0 ? ((e.align = "right"), (e.inside = !0)) : (d += n.plotWidth - p), (u = !0)),
                            (p = i.y + l) < 0 && ("bottom" === h && c >= 0 ? ((e.verticalAlign = "top"), (e.inside = !0)) : (c -= p), (u = !0)),
                            (p = (i.y || 0) + s.height - l) > n.plotHeight && ("top" === h && c <= 0 ? ((e.verticalAlign = "bottom"), (e.inside = !0)) : (c += n.plotHeight - p), (u = !0)),
                            u && ((e.x = d), (e.y = c), (t.placed = !r), t.align(e, void 0, o)),
                            u
                        );
                    }
                    function S(t, e) {
                    ...
                    function M(t, e, i, s, o) {
                        ...
                        (e.startXPos = n ? o.x : h ? -l - c : a.width - l + c),
                            (e.startYPos = n ? (h ? this.yAxis.height - l + c : -l - c) : o.y),
                            s ? "hidden" === e.visibility && (e.show(), e.attr({ opacity: 0 }).animate({ opacity: 1 })) : e.attr({ opacity: 1 }).animate({ opacity: 0 }, void 0, e.hide),
                ...
                (function (e) {
                    function i(t, e, i, s, o) {
                        ...
                        if (p) {
                            ...
                            r && (s = { x: c - s.y - s.height, y: d - s.x - s.width, width: s.height, height: s.width }), g || (r ? ((s.x += u ? 0 : s.width), (s.width = 0)) : ((s.y += u ? s.height : 0), (s.height = 0)));
                        }
                        (i.align = h(i.align, !r || g ? "center" : u ? "right" : "left")),
                            (i.verticalAlign = h(i.verticalAlign, r || g ? "middle" : u ? "top" : "bottom")),
        ...
        i(e, "Series/Scatter/ScatterSeriesDefaults.js", [], function () {
            return {
                ...
                jitter: { x: 0, y: 0 },
                marker: { enabled: !0 },
                tooltip: { headerFormat: '<span style="color:{point.color}">●</span> <span style="font-size: 0.8em"> {series.name}</span><br/>', pointFormat: "x: <b>{point.x}</b><br/>y: <b>{point.y}</b><br/>" },
            };
        }),
        i(e, "Series/Scatter/ScatterSeries.js", [e["Series/Scatter/ScatterSeriesDefaults.js"], e["Core/Series/SeriesRegistry.js"], e["Core/Utilities.js"]], function (t, e, i) {
            ...
            return (
                ...
                n(h.prototype, { drawTracker: s.prototype.drawTracker, sorted: !1, requireSorting: !1, noSharedTooltip: !0, trackerGroups: ["group", "markerGroup", "dataLabelsGroup"] }),
        ...
        i(e, "Series/Pie/PiePoint.js", [e["Core/Animation/AnimationUtilities.js"], e["Core/Series/Point.js"], e["Core/Utilities.js"]], function (t, e, i) {
            let { setAnimation: s } = t,
                { addEvent: o, defined: r, extend: n, isNumber: a, isString: h, pick: l, relativeLength: d } = i;
            class c extends e {
                getConnectorPath(t) {
        ...
        i(
            ...
            function (t, e, i, s, o, r, n, a, h) {
                let { getStartAndEndRadians: l } = t,
                    { noop: d } = i,
                    { clamp: c, extend: p, fireEvent: u, merge: g, pick: f, relativeLength: m, splat: x } = h;
                class y extends r {
                    animate(t) {
                        let e = this,
                            i = e.points,
                        ...
                        t ||
                            i.forEach(function (t) {
                                let i = t.graphic,
                                    o = t.shapeArgs;
                                i && o && (i.attr({ r: f(t.startR, e.center && e.center[3] / 2), start: s, end: s }), i.animate({ r: o.r, start: o.start, end: o.end }, e.options.animation));
                            });
                    }
                    drawEmpty() {
                        let t, e;
                            ...
                            ? ((t = this.center[0]),
                              ...
                              this.graph ||
                                  (this.graph = this.chart.renderer
                                      ...
                                      .add(this.group)),
                              this.graph.attr({ d: a.arc(t, e, this.center[2] / 2, 0, { start: i, end: s, innerR: this.center[3] / 2 }) }),
                              this.chart.styledMode || this.graph.attr({ "stroke-width": o.borderWidth, fill: o.fillColor || "none", stroke: o.color || "#cccccc" }))
                                ...
                                (e = n.graphic),
                                    !n.isNull && e
                                        ? ((s = n.shapeArgs),
                                          ...
                                          n.delayedRendering
                                              ? (e.setRadialReference(o.center).attr(s).attr(t), r.styledMode || e.attr(i).attr({ "stroke-linejoin": "round" }), (n.delayedRendering = !1))
                                              : (e.setRadialReference(o.center), r.styledMode || g(!0, a, i), g(!0, a, s, t), e.animate(a)),
                    ...
                    translate(t) {
                        ...
                        for (t || (this.center = t = this.getCenter()), x = 0; x < d; x++) {
                            ...
                            let e = { x: t[0], y: t[1], r: t[2] / 2, innerR: t[3] / 2, start: Math.round(1e3 * c) / 1e3, end: Math.round(1e3 * p) / 1e3 };
                            (y.shapeType = "arc"),
                                (y.shapeArgs = e),
                                (g = (p + c) / 2) > 1.5 * Math.PI ? (g -= 2 * Math.PI) : g < -Math.PI / 2 && (g += 2 * Math.PI),
                                (y.slicedTranslation = { translateX: Math.round(Math.cos(g) * i), translateY: Math.round(Math.sin(g) * i) }),
                                (f = (Math.cos(g) * t[2]) / 2),
                                (m = (Math.sin(g) * t[2]) / 2),
        ...
        i(e, "Series/Pie/PieDataLabel.js", [e["Core/Series/DataLabel.js"], e["Core/Globals.js"], e["Core/Renderer/RendererUtilities.js"], e["Core/Series/SeriesRegistry.js"], e["Core/Utilities.js"]], function (t, e, i, s, o) {
            ...
            let { composed: n, noop: a } = e,
                { distribute: h } = i,
                { series: l } = s,
                { arrayMax: d, clamp: c, defined: p, pick: u, pushUnique: g, relativeLength: f } = o;
            return (
                (function (e) {
                    let i = {
                        ...
                        t.visible &&
                            ...
                            (e.forEach((t) => {
                                (t.dataLabels || []).forEach((t) => {
                                    t.shortened && (t.attr({ width: "auto" }).css({ width: "auto", textOverflow: "clip" }), (t.shortened = !1));
                                });
                            }),
                            ...
                            e.forEach((t) => {
                                (t.dataLabels || []).forEach((e, i) => {
                                    let s = a[2] / 2,
                                        ...
                                        r = f(o?.distance || 0, s);
                                    0 === i && m[t.half].push(t),
                                        !p(o?.style?.width) && e.getBBox().width > n && (e.css({ width: Math.round(0.7 * n) + "px" }), (e.shortened = !0)),
                                        ...
                                        e.forEach((t) => {
                                            (t.dataLabels || []).forEach((e, s) => {
                                                ...
                                                o &&
                                                    ...
                                                    (o.bottom = Math.min(g + c + o.distance, i.plotHeight)),
                                                    (b = e.getBBox().height || 21),
                                                    (t.distributeBox = { target: (e.dataLabelPosition?.natural.y || 0) - o.top + b / 2, size: b, rank: t.y }),
                                    ...
                                    e.forEach((i) => {
                                        (i.dataLabels || []).forEach((h) => {
                                            ...
                                            if (f) {
                                                ...
                                                if (
                                                    ((f.attribs = { visibility: C, align: f.alignment }),
                                                    (f.posAttribs = { x: k + (l.x || 0) + ({ left: b, right: -b }[f.alignment] || 0), y: M + (l.y || 0) - h.getBBox().height / 2 }),
                                                    (f.computed.x = k),
                                                    (f.computed.y = M),
                                                    u(l.crop, !0))
                                                ) {
                                                    ...
                                                    k - (v = h.getBBox().width) < b && 1 === n
                                                        ? ((t = Math.round(v - k + b)), (x[3] = Math.max(t, x[3])))
                                                        : k + v > s - b && 0 === n && ((t = Math.round(k + v - s + b)), (x[1] = Math.max(t, x[1]))),
                                                        M - S / 2 < 0 ? (x[0] = Math.max(Math.round(-M + S / 2), x[0])) : M + S / 2 > o && (x[2] = Math.max(Math.round(M + S / 2 - o), x[2])),
                                                        (f.sideOverflow = t);
                                                }
                                            }
                                        });
                                                    ...
                                                    ? ((a = !b),
                                                      b ||
                                                          (s.connector = b = i.renderer
                                                              .path()
                                                              .addClass("highcharts-data-label-connector  highcharts-color-" + e.colorIndex + (e.className ? " " + e.className : ""))
                                                              .add(t.dataLabelsGroup)),
                                                      i.styledMode || b.attr({ "stroke-width": r, stroke: o || e.color || "#666666" }),
                                                      b[a ? "attr" : "animate"]({ d: e.getConnectorPath(s) }),
                    ...
                    function r() {
                        this.points.forEach((t) => {
                            (t.dataLabels || []).forEach((t) => {
                                let e = t.dataLabelPosition;
                                e
                                    ? (e.sideOverflow && (t.css({ width: Math.max(t.getBBox().width - e.sideOverflow, 0) + "px", textOverflow: (t.options?.style || {}).textOverflow || "ellipsis" }), (t.shortened = !0)),
                                      t.attr(e.attribs),
                    ...
                    function m(t) {
                        ...
                        return (
                            !n &&
                                (null !== s[0] ? (r = Math.max(e[2] - Math.max(t[1], t[3]), o)) : ((r = Math.max(e[2] - t[1] - t[3], o)), (e[0] += (t[3] - t[1]) / 2)),
                                null !== s[1] ? (r = c(r, o, e[2] - Math.max(t[0], t[2]))) : ((r = c(r, o, e[2] - t[0] - t[2])), (e[1] += (t[0] - t[2]) / 2)),
                                r < e[2]
                                    ? ((e[2] = r), (e[3] = Math.min(i.thickness ? Math.max(0, r - 2 * i.thickness) : Math.max(0, f(i.innerSize || 0, r)), r)), this.translate(e), this.drawDataLabels && this.drawDataLabels())
                                    : (n = !0)),
                            n
                        );
                    }
        ...
        i(e, "Extensions/OverlappingDataLabels.js", [e["Core/Globals.js"], e["Core/Utilities.js"]], function (t, e) {
            let { composed: i } = t,
                { addEvent: s, fireEvent: o, isNumber: r, objectEach: n, pick: a, pushUnique: h } = e;
            function l(t) {
                let e = t.length,
                    i = this.renderer,
                    ...
                    n = (t) => {
                        ...
                        if (t && (!t.alignAttr || t.placed))
                            return (
                                ...
                                (o = t.parentGroup),
                                t.width || ((n = t.getBBox()), (t.width = n.width), (t.height = n.height), (a = i.fontMetrics(t.element).h)),
                                (l = t.width - 2 * e),
                                (d = { left: "0", center: "0.5", right: "1" }[t.alignValue]) ? (h = +d * l) : r(t.x) && Math.round(t.x) !== t.translateX && (h = t.x - (t.translateX || 0)),
                                { x: s.x + (o.translateX || 0) + e - (h || 0), y: s.y + (o.translateY || 0) + e - a, width: t.width - 2 * e, height: (t.height || 0) - 2 * e }
                            );
                    },
                    a,
                    h,
                ...
                for (let i = 0; i < e; ++i) {
                    ...
                    for (let o = i + 1; o < e; ++o)
                        (p = (l = t[o]) && l.absoluteBox),
                            c && p && h !== l && 0 !== h.newOpacity && 0 !== l.newOpacity && "hidden" !== h.visibility && "hidden" !== l.visibility && s(c, p) && ((h.labelrank < l.labelrank ? h : l).newOpacity = 0);
                }
        ...
        i(e, "Extensions/BorderRadius.js", [e["Core/Defaults.js"], e["Core/Globals.js"], e["Core/Utilities.js"]], function (t, e, i) {
            let { defaultOptions: s } = t,
                { composed: o, noop: r } = e,
                { addEvent: n, extend: a, isObject: h, merge: l, pushUnique: d, relativeLength: c } = i,
                    ...
                    !(function (t, e, i) {
                        ...
                        if (("Z" === a[0] && (a = t[0]), ("M" === n[0] || "L" === n[0]) && "A" === a[0] ? ((s = n), (o = a), (r = !0)) : "A" === n[0] && ("M" === a[0] || "L" === a[0]) && ((s = a), (o = n)), s && o && o.params)) {
                            let n = o[1],
                                ...
                                m = Math.cos(g) * u;
                            r
                                ? ((h.start = l + f), (s[1] = c + m * Math.cos(l)), (s[2] = p + m * Math.sin(l)), t.splice(e + 1, 0, ["A", i, i, 0, 0, 1, c + n * Math.cos(h.start), p + n * Math.sin(h.start)]))
                                : ((h.end = d - f), (o[6] = c + n * Math.cos(h.end)), (o[7] = p + n * Math.sin(h.end)), t.splice(e + 1, 0, ["A", i, i, 0, 0, 1, c + m * Math.cos(d), p + m * Math.sin(d)])),
        ...
        i(e, "Core/Responsive.js", [e["Core/Globals.js"], e["Core/Utilities.js"]], function (t, e) {
            var i;
            let { composed: s } = t,
                { diffObjects: o, extend: r, find: n, merge: a, pick: h, pushUnique: l, uniqueKey: d } = e;
            return (
                (function (t) {
                    function e(t, e) {
                        let i = t.condition,
                    ...
                    function i(t, e) {
                        ...
                        r !== c &&
                            ...
                            r
                                ? (((h = o(l, this.options, !0, this.collectionsWithUpdate)).isResponsiveOptions = !0), (this.currentResponsive = { ruleIds: r, mergedOptions: l, undoOptions: h }), this.update(l, t, !0))
